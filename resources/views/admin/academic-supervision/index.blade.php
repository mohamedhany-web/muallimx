...
<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($supervisors as $sup)
                        <tr class="hover:bg-gray-50/80">
                            <td class="px-4 py-3">
                                <p class="font-semibold text-gray-900">{{ $sup->name }}</p>
                                <p class="text-xs text-gray-500">{{ $sup->email }}</p>
                            </td>
        ...
        <div class="px-4 py-3 border-t border-gray-100">{{ $supervisors->links() }}</div>
    </div>
</div>
@endsection
