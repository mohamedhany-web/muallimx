    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="rounded-3xl bg-white/95 backdrop-blur border border-slate-200 shadow-lg p-5 sm:p-8 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="code" required value="{{ old('code') }}" class="w-full rounded-xl border-slate-300 uppercase font-mono" placeholder="WELCOME10">
            ...
            <div>
                ...
                <input type="text" name="title" required value="{{ old('title') }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="number" name="discount_value" step="0.01" min="0" required value="{{ old('discount_value') }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="number" name="minimum_amount" step="0.01" min="0" value="{{ old('minimum_amount') }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="number" name="maximum_discount" step="0.01" min="0" value="{{ old('maximum_discount') }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="number" name="max_uses" min="1" value="{{ old('max_uses') }}" class="w-full rounded-xl border-slate-300" placeholder="اتركه فارغاً لغير محدود">
            ...
            <div>
                ...
                <input type="number" name="usage_limit_per_user" min="1" value="{{ old('usage_limit_per_user', 1) }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="date" name="valid_from" value="{{ old('valid_from') }}" class="w-full rounded-xl border-slate-300">
            ...
            <div>
                ...
                <input type="date" name="valid_until" value="{{ old('valid_until') }}" class="w-full rounded-xl border-slate-300">
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="w-full rounded-xl border-slate-300">{{ old('description') }}</textarea>
        ...
        <div class="rounded-2xl border border-slate-200 p-5 space-y-5 bg-slate-50/70">
            ...
            @error('applicable_to')<p class="text-red-500 text-xs">{{ $message }}</p>@enderror
        ...
        <div class="rounded-2xl border border-amber-200 p-5 space-y-4 bg-amber-50/50">
            ...
            <div>
                ...
                <textarea name="applicable_user_ids_text" rows="2" class="w-full rounded-xl border-slate-300 font-mono text-sm" placeholder="مثال: 12, 45 أو سطر لكل رقم">{{ old('applicable_user_ids_text') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="beneficiary_user_id" min="1" value="{{ old('beneficiary_user_id') }}" class="w-full rounded-xl border-slate-300 font-mono" placeholder="فارغ = بدون عمولة">
                ...
                <div>
                    ...
                    <input type="number" name="commission_percent" step="0.01" min="0" max="100" value="{{ old('commission_percent') }}" class="w-full rounded-xl border-slate-300">
