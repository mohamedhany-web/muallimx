            ...
            <form action="{{ route('admin.referral-programs.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all">{{ old('description') }}</textarea>
                </div>
