    ...
    <div class="bg-white rounded-2xl shadow border border-slate-200 overflow-hidden">
        ...
        @else
            <div class="px-6 py-4">
                ...
                @else
                    <p class="text-slate-500 text-sm">لا يوجد ملف مرفق. الرابط الخارجي فقط: @if($dataset->file_url) <a href="{{ $dataset->file_url }}" target="_blank" rel="noopener" class="text-cyan-600 hover:underline">{{ $dataset->file_url }}</a> @else — @endif</p>
                @endif
            </div>
        @endif
    </div>
