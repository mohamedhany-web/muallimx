        ...
        <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900 dark:text-slate-100">{{ number_format($quickStats['total_users']) }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900 dark:text-slate-100">{{ number_format($quickStats['total_students']) }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900 dark:text-slate-100">{{ number_format($quickStats['total_courses']) }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900 dark:text-slate-100">{{ number_format($quickStats['total_invoices']) }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900 dark:text-slate-100">{{ number_format($quickStats['total_activities']) }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($reportCategories as $category)
            ...
            <div class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200">
                <div class="px-6 py-5 {{ $colors['header'] }} border-b border-slate-200 dark:border-slate-700">
                    <div class="flex items-center gap-4 mb-3">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-black text-slate-900 dark:text-slate-100">{{ $category['name'] }}</h3>
                            <p class="text-xs text-slate-600 dark:text-slate-400 mt-1">{{ $category['description'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
