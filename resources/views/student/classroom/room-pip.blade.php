...
<head>
    ...
    <title>مشاركون — {{ $meeting->title ?: $meeting->code }}</title>
...
<script>
(function () {
    var jitsiDomain = @json($jitsiDomain);
    var roomName = @json($meeting->room_name);
    var userName = @json(($user->name ?: 'معلم') . ' · نافذة');
