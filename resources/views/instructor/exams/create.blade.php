    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6 mb-6">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div class="min-w-0">
                    <h1 class="text-xl sm:text-2xl font-bold text-slate-800">{{ __('instructor.create_exam_new') }}</h1>
                    <p class="text-sm text-slate-600 mt-0.5">{{ __('instructor.add_exam_to_course') }}</p>
                </div>
            </div>
