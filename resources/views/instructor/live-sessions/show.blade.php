    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            @if($liveSession->isLive())
                <a href="{{ route('instructor.live-sessions.room', $liveSession) }}" class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg text-sm font-semibold shadow-lg shadow-red-500/25 transition-all">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                ...
                <div class="grid sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div><span class="text-slate-500">الحد الأقصى:</span> <span class="font-semibold text-slate-800 dark:text-white mr-2">{{ $liveSession->max_participants }}</span></div>
                </div>
