...
<head>
    ...
    <title>503 - <?php echo e(__('errors.503_title')); ?> | Mindlytics</title>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 lg:py-20">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center fade-in-up" style="animation-delay: 0.5s;">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-teal-600 px-8 py-4 rounded-full font-bold text-base border-2 border-teal-600 hover:bg-teal-50 transition-all duration-300">
...
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\errors\503.blade.php ENDPATH**/ ?>