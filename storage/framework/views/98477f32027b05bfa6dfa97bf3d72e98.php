    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-600"><?php echo e(__('عرض تفاصيل الرسالة المرسلة عبر الواتساب')); ?></p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-200">
                ...
                <div class="space-y-3">
                    <?php if($message->status === 'failed'): ?>
                        <form action="<?php echo e(route('admin.messages.resend', $message)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" 
                                    onclick="return confirm('<?php echo e(__('هل تريد إعادة إرسال هذه الرسالة؟')); ?>')"
