...
<div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <form action="<?php echo e(route('instructor.assignments.update', $assignment)); ?>" method="POST" class="rounded-2xl bg-white dark:bg-slate-800/95 border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-5">
        <?php echo csrf_field(); ?>
