...
<div class="container mx-auto px-4 py-8 space-y-6">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div class="xl:col-span-2 bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
            ...
            <form action="<?php echo e(route('admin.subscriptions.update', $subscription)); ?>" method="POST" class="space-y-8" x-data="editTeacherSubscriptionForm(<?php echo json_encode($subscription->features ?? [], 15, 512) ?>, '<?php echo e($subscription->teacher_plan_key ?? ''); ?>')">
                <?php echo csrf_field(); ?>
