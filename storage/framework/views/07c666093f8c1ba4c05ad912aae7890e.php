...
<div class="w-full">
    ...
    <form action="<?php echo e(route('community.contributor.datasets.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <?php echo csrf_field(); ?>
