...
<?php $__env->startSection('title', 'وايت بورد'); ?>
<?php $__env->startSection('header', 'وايت بورد'); ?>
...
<style>
    ...
    /* إخفاء مكتبة Excalidraw */
    .mx-hide-excalidraw-library .excalidraw .layer-ui__library,
    .mx-hide-excalidraw-library .excalidraw .layer-ui__library-message,
    .mx-hide-excalidraw-library .excalidraw .library-menu,
    .mx-hide-excalidraw-library .excalidraw .library-menu-dropdown-container,
    .mx-hide-excalidraw-library .excalidraw .library-menu-dropdown-container--in-heading,
    .mx-hide-excalidraw-library .excalidraw .library-menu-items-container,
    .mx-hide-excalidraw-library .excalidraw .library-menu-control-buttons,
    .mx-hide-excalidraw-library .excalidraw .library-menu-control-buttons--at-bottom,
    .mx-hide-excalidraw-library .excalidraw .library-menu-browse-button,
    .mx-hide-excalidraw-library .excalidraw .library-menu-items-private-library-container,
    .mx-hide-excalidraw-library .excalidraw .library-actions-counter,
    .mx-hide-excalidraw-library .excalidraw .single-library-item,
    .mx-hide-excalidraw-library .excalidraw .single-library-item-wrapper,
    .mx-hide-excalidraw-library .excalidraw .library-unit,
    .mx-hide-excalidraw-library .excalidraw .selected-library-items,
    .mx-hide-excalidraw-library .excalidraw [class*="publish-library"] {
...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6 space-y-4">
    <p class="text-sm text-slate-600 dark:text-slate-400">لوحة مستقلة خارج الاجتماع — يمكنك التصدير من قائمة Excalidraw (PNG/SVG).</p>
    <div class="mx-standalone-excalidraw-wrap bg-slate-900">
        <div id="mx-standalone-excalidraw-root" class="mx-hide-excalidraw-library" data-lang="ar"></div>
        <div id="mx-standalone-loading">جاري تحميل اللوحة…</div>
    </div>
</div>
        ...
        function tick() {
            ...
            try {
                ...
                if (Excalidraw == null || (typeof Excalidraw !== 'function' && typeof Excalidraw !== 'object')) {
                    throw new Error('مكوّن Excalidraw غير متاح');
                }
