                    ...
                    <tr class="text-xs font-semibold uppercase tracking-widest text-slate-700">
                        <th class="px-4 py-4 text-center w-20">
                            <div class="flex flex-col items-center gap-1">
                                ...
                                <span class="normal-case tracking-normal text-[10px] leading-tight">الملف الشخصي</span>
                            </div>
                        </th>
                        ...
                        <tr class="table-row">
                            <td class="px-4 py-4 text-center align-middle">
                                <div class="inline-flex justify-center">
                                    <?php echo $__env->make('admin.partials.user-profile-thumb', ['user' => $user, 'size' => 'md'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="space-y-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section class="user-card rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 space-y-3 max-h-96 overflow-y-auto">
                ...
                <div class="flex items-center gap-4 p-3 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200">
                    <?php echo $__env->make('admin.partials.user-profile-thumb', ['user' => $recentUser, 'size' => 'md'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <div class="flex-1 min-w-0">
        ...
        <section class="user-card rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 space-y-3 max-h-96 overflow-y-auto">
                ...
                <div class="flex items-center gap-4 p-3 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200">
                    <?php echo $__env->make('admin.partials.user-profile-thumb', ['user' => $activeUser, 'size' => 'md'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <div class="flex-1 min-w-0">
