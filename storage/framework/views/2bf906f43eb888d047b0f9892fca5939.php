...
<?php $__env->startSection('header', __('student.settings_title')); ?>
...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-1"><?php echo e(__('student.settings_title')); ?></h1>
        <p class="text-sm text-gray-500"><?php echo e(__('student.settings_subtitle')); ?></p>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="settings-card p-5 sm:p-6">
            <div class="flex items-center gap-3 mb-5">
                ...
                <h2 class="text-lg font-bold text-gray-900"><?php echo e(__('student.notification_settings')); ?></h2>
            </div>
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-sky-50/50 rounded-xl border border-sky-100">
                    <div class="flex-1 min-w-0">
                        <h3 class="text-sm font-bold text-gray-900 mb-0.5"><?php echo e(__('student.new_courses_notif')); ?></h3>
                        <p class="text-xs text-gray-600"><?php echo e(__('student.new_courses_notif_desc')); ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between p-4 bg-sky-50/50 rounded-xl border border-sky-100">
                    <div class="flex-1 min-w-0">
                        <h3 class="text-sm font-bold text-gray-900 mb-0.5"><?php echo e(__('student.orders_notif')); ?></h3>
                        <p class="text-xs text-gray-600"><?php echo e(__('student.orders_notif_desc')); ?></p>
                    </div>
                    <label class="toggle-switch flex-shrink-0 mr-2">
                        <input type="checkbox" checked>
                        <span class="toggle-slider"></span>
                ...
                <div class="flex items-center justify-between p-4 bg-sky-50/50 rounded-xl border border-sky-100">
                    <div class="flex-1 min-w-0">
                        <h3 class="text-sm font-bold text-gray-900 mb-0.5"><?php echo e(__('student.exams_notif')); ?></h3>
                        <p class="text-xs text-gray-600"><?php echo e(__('student.exams_notif_desc')); ?></p>
                    </div>
                    <label class="toggle-switch flex-shrink-0 mr-2">
                        <input type="checkbox" checked>
                        <span class="toggle-slider"></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\student\settings\index.blade.php ENDPATH**/ ?>