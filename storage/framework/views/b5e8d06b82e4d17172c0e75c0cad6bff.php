        ...
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($quickStats['total_users'])); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($quickStats['total_students'])); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($quickStats['total_courses'])); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($quickStats['total_invoices'])); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($quickStats['total_activities'])); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__currentLoopData = $reportCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200">
                <div class="px-6 py-5 <?php echo e($colors['header']); ?> border-b border-slate-200">
                    <div class="flex items-center gap-4 mb-3">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-black text-slate-900"><?php echo e($category['name']); ?></h3>
                            <p class="text-xs text-slate-600 mt-1"><?php echo e($category['description']); ?></p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
