...
<?php $__env->startSection('title', 'المعاملات المالية - التقارير المحاسبية - Mindlytics'); ?>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-right text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 font-semibold <?php echo e($transaction->type == 'credit' ? 'text-emerald-600' : 'text-rose-600'); ?>"><?php echo e(number_format($transaction->amount, 2)); ?> ج.م</td>
                        <td class="px-4 py-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\accounting\reports-transactions.blade.php ENDPATH**/ ?>