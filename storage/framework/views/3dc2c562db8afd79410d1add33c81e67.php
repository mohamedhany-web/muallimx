...
<?php $__env->startSection('title', __('instructor.create_question_bank_new') . ' - Mindlytics'); ?>
...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6 mb-6">
        <nav class="text-sm text-slate-500 mb-2">
            ...
            <span class="text-slate-700 font-semibold"><?php echo e(__('instructor.create_bank')); ?></span>
        </nav>
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div class="min-w-0">
                    <h1 class="text-xl sm:text-2xl font-bold text-slate-800"><?php echo e(__('instructor.create_question_bank_new')); ?></h1>
                    <p class="text-sm text-slate-600 mt-0.5"><?php echo e(__('instructor.create_question_bank_desc')); ?></p>
                </div>
            </div>
            <a href="<?php echo e(route('instructor.question-banks.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-semibold transition-colors">
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
        <form action="<?php echo e(route('instructor.question-banks.store')); ?>" method="POST">
            ...
            <div class="p-6 sm:p-8 space-y-8">
                <!-- معلومات بنك الأسئلة -->
                <div class="space-y-6">
                    <h2 class="text-lg font-bold text-slate-800 border-b border-slate-200 pb-2"><?php echo e(__('instructor.question_bank_info')); ?></h2>
                    <div>
                        <label for="title" class="block text-sm font-semibold text-slate-700 mb-1"><?php echo e(__('instructor.title_required')); ?> <span class="text-red-500">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="max-w-xs">
                        <label for="difficulty" class="block text-sm font-semibold text-slate-700 mb-1"><?php echo e(__('instructor.difficulty')); ?></label>
                ...
                <div class="space-y-4 pt-6 border-t border-slate-200">
                    <h2 class="text-lg font-bold text-slate-800 border-b border-slate-200 pb-2"><?php echo e(__('instructor.status_label')); ?></h2>
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>

                               class="rounded border-slate-300 text-sky-600 focus:ring-sky-500">
                        <span class="text-sm font-medium text-slate-700"><?php echo e(__('instructor.bank_active')); ?></span>
                    </label>
                </div>
                ...
                <div class="pt-6 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex gap-3 shrink-0">
                        ...
                        <a href="<?php echo e(route('instructor.question-banks.index')); ?>" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-semibold transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/instructor/question-banks/create.blade.php ENDPATH**/ ?>