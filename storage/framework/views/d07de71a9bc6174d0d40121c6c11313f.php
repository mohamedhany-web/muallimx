    ...
    <style>
        * { box-sizing: border-box; }
        body {
            ...
            color: <?php echo e($navyDark); ?>;
        }
        .wrap {
            border: 2px solid <?php echo e($gold); ?>;
            background: #fffefb;
            min-height: 175mm;
        }
        .top-band {
        ...
        .meta-value { font-size: 9pt; font-weight: bold; color: <?php echo e($navyDark); ?>; }
        .footer {
            width: 100%;
            border-collapse: collapse;
        ...
        .sign-name {
            ...
            font-style: italic;
            color: <?php echo e($navyDark); ?>;
            border-bottom: 1px solid <?php echo e($navyDark); ?>;
            padding-bottom: 1mm;
            margin-bottom: 1mm;
        }
...
<div class="wrap">
        ...
        <table>
            <tr>
                ...
                <td style="width:30%;">
                    ...
                    <div class="cert-no"><?php echo e($certificateNumber); ?></div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="body">
        <?php if(!empty($watermarkDataUri)): ?>
            <img class="wm" src="<?php echo e($watermarkDataUri); ?>" alt="">
        <?php endif; ?>
        ...
        <div class="course"><?php echo e($courseDisplayName); ?></div>
        <div class="text">المُقدَّم عبر منصة <strong style="color:<?php echo e($orange); ?>;"><?php echo e($brandSlug); ?></strong></div>
        ...
        <table class="meta">
            <tr>
                ...
                <td>
                    ...
                    <div class="meta-value"><?php echo e($instructorName); ?></div>
                </td>
                <td>
                    <div class="meta-label">مدة الدورة</div>
                    <div class="meta-value"><?php echo e($courseDurationLabel ?? '—'); ?></div>
                </td>
                <td>
                    <div class="meta-label">رمز التحقق</div>
                    <div class="meta-value" style="font-size:7pt;"><?php echo e($verificationCode); ?></div>
                </td>
            </tr>
        </table>
        ...
        <table class="footer">
            <tr>
                ...
                <td>
                    <div class="seal">
                        <?php echo e($brandSlug); ?><br>CERTIFIED<br>
                ...
                <td>
                    <?php if(!empty($qrDataUri)): ?>
                        <div class="qr-box">
                            <img src="<?php echo e($qrDataUri); ?>" alt="QR" style="width:20mm;height:20mm;display:block;">
                        </div>
                        <div class="qr-label">امسح للتحقق</div>
                    <?php elseif(!empty($verificationCode)): ?>
                        <div class="meta-value" style="font-size:7pt;"><?php echo e($verificationCode); ?></div>
                    <?php endif; ?>
                </td>
                <td>
...
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\pdf\certificates\platform-enhanced.blade.php ENDPATH**/ ?>