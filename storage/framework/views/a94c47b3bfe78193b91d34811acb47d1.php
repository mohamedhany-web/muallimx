...
<?php $__env->startSection('title', 'تعديل السؤال - ' . config('app.name', 'Muallimx')); ?>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="question_type" required onchange="updateQuestionForm()"
                                ...
                                <option value="fill_blank" <?php echo e($question->type == 'fill_blank' ? 'selected' : ''); ?>>املأ الفراغ</option>
                                <option value="short_answer" <?php echo e($question->type == 'short_answer' ? 'selected' : ''); ?>>إجابة قصيرة</option>
                                <option value="essay" <?php echo e($question->type == 'essay' ? 'selected' : ''); ?>>مقالي</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="correct_answer_field">
                                ...
                                <select name="correct_answer" class="form-input w-full px-4 py-3 rounded-xl focus:outline-none">
                                    ...
                                    <?php if($question->options && is_array($question->options)): ?>
                                        <?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($option); ?>" <?php echo e(in_array($option, $correctAnswer) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                            ...
                            <!-- لاملأ الفراغ -->
                            <div id="correct_answer_fill_blank" style="display: <?php echo e($question->type == 'fill_blank' ? 'block' : 'none'); ?>;">
                                <textarea name="correct_answer" rows="3"
                                          class="form-input w-full px-4 py-3 rounded-xl focus:outline-none"
                                          placeholder="أدخل الإجابات الصحيحة (كل إجابة في سطر)"><?php echo e($correctAnswerValue); ?></textarea>
                                <p class="mt-1 text-xs text-gray-500">يمكن إدخال عدة إجابات صحيحة، كل إجابة في سطر منفصل</p>
                            </div>
                            
                            <!-- لإجابة قصيرة -->
                            <div id="correct_answer_short_answer" style="display: <?php echo e($question->type == 'short_answer' ? 'block' : 'none'); ?>;">
                                <input type="text" name="correct_answer" value="<?php echo e($correctAnswer[0] ?? ''); ?>"
                                       class="form-input w-full px-4 py-3 rounded-xl focus:outline-none"
                                       placeholder="الإجابة الصحيحة (كلمة أو جملة قصيرة)">
                            </div>
                            
                            <!-- لمقالي -->
                            <div id="correct_answer_essay" style="display: <?php echo e($question->type == 'essay' ? 'block' : 'none'); ?>;">
                                <textarea name="correct_answer" rows="5"
                                          class="form-input w-full px-4 py-3 rounded-xl focus:outline-none"
                                          placeholder="نموذج الإجابة المثالية أو النقاط الرئيسية للإجابة..."><?php echo e($correctAnswerValue); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\instructor\questions\edit.blade.php ENDPATH**/ ?>