...
<?php $__env->startSection('title', 'تعديل الصلاحية'); ?>
<?php $__env->startSection('header', 'تعديل الصلاحية'); ?>
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">تعديل معلومات الصلاحية: <?php echo e($permission->display_name); ?></p>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="وصف مختصر للصلاحية (اختياري)"><?php echo e(old('description', $permission->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="group" id="group" value="<?php echo e(old('group', $permission->group)); ?>"
                           list="groups"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p class="text-sm text-blue-800">
                        ...
                        هذه الصلاحية مرتبطة بـ <strong><?php echo e($permission->roles->count()); ?></strong> دور. 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\permissions\edit.blade.php ENDPATH**/ ?>