            ...
            <div class="space-y-3 max-h-80 overflow-y-auto">
                <?php $__currentLoopData = $availableQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form action="<?php echo e(route('instructor.exams.questions.add-from-bank', $exam)); ?>" method="POST" class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-sky-200 hover:bg-sky-50 dark:bg-sky-900/30/30 transition-colors">
                        ...
                        <input type="number" name="marks" value="<?php echo e($question->points ?? 1); ?>" min="0.5" step="0.5" class="w-16 px-2 py-1.5 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-center">
