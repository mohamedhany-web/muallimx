...
<div class="space-y-6">
    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white dark:bg-slate-800/95 border border-slate-200 dark:border-slate-700 shadow-sm">
        <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-1"><?php echo e(__('instructor.my_courses')); ?></h1>
        <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('instructor.courses_assigned_to_you')); ?></p>
    </div>
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <span class="text-slate-800 dark:text-slate-100 font-semibold"><?php echo e(number_format($course->price, 2)); ?> ج.م</span>
                        </div>
                        <?php else: ?>
                        <div class="flex items-center gap-2 text-sm">
                            <div class="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center flex-shrink-0">
