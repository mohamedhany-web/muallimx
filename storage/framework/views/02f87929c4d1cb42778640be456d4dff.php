<?php $__env->startSection('title', 'إدارة المدفوعات - ' . config('app.name', 'Muallimx')); ?>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                ...
                                <div class="flex-1 min-w-0 space-y-1">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 text-xs text-slate-600 dark:text-slate-400">
                                        <span><i class="fas fa-coins text-emerald-500 dark:text-emerald-400 ml-0.5"></i> <strong><?php echo e(number_format($payment->amount, 2)); ?></strong> ج.م</span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views/admin/payments/index.blade.php ENDPATH**/ ?>