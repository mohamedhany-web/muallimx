    ...
    <div class="min-h-screen py-12 px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
                <form method="GET" action="<?php echo e(route('public.certificates.verify')); ?>" class="flex gap-4">
                    <input type="text" 
                           name="code" 
            ...
            <?php if(isset($certificate)): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div><span class="text-gray-600">الاسم:</span> <span class="font-semibold text-gray-900"><?php echo e($certificate->user->name ?? 'غير معروف'); ?></span></div>
                                    <div><span class="text-gray-600">البريد:</span> <span class="font-semibold text-gray-900"><?php echo e($certificate->user->email ?? '-'); ?></span></div>
                                </div>
                            </div>
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-4">معلومات الشهادة</h3>
                                <div class="space-y-2 text-sm">
                                    <div><span class="text-gray-600">رقم الشهادة:</span> <span class="font-semibold text-gray-900 font-mono"><?php echo e($certificate->certificate_number); ?></span></div>
                                    <?php if($certificate->serial_number): ?>
                                    <div><span class="text-gray-600">السيريال:</span> <span class="font-semibold text-gray-900 font-mono"><?php echo e($certificate->serial_number); ?></span></div>
                                    <?php endif; ?>
                                    <div><span class="text-gray-600">تاريخ الإصدار:</span> <span class="font-semibold text-gray-900"><?php echo e($certificate->issued_at ? $certificate->issued_at->format('Y-m-d') : '-'); ?></span></div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-red-500">
                    <div class="text-center">
                        ...
                        <p class="text-red-600 font-semibold"><?php echo e($error ?? 'تم اكتشاف تلاعب في الشهادة أو الشهادة غير موجودة'); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-yellow-500">
                <div class="text-center">
                    ...
                    <p class="text-yellow-600 font-semibold"><?php echo e($error); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\public\certificates\verify.blade.php ENDPATH**/ ?>