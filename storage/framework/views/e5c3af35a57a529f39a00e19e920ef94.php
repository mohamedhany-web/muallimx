...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="domain" value="<?php echo e(old('domain')); ?>" required class="w-full rounded-lg border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white" placeholder="live.mualimx.com">
