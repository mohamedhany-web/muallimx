...
<nav id="mainNavbar" 
        ...
        <div class="flex justify-between items-center h-24">
            ...
            <div class="flex items-center space-x-4 space-x-reverse">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div>
                        <h1 class="text-2xl font-black text-blue-900 text-glow"><?php echo e(config('app.name', 'Muallimx')); ?></h1>
    ...
    <div x-show="mobileMenu"
        ...
        <div class="h-full bg-gradient-to-b from-blue-50/95 to-blue-100/95 backdrop-blur-xl border-t border-blue-200/30 shadow-xl px-6 py-8 space-y-6 overflow-y-auto pointer-events-auto">
            ...
            <a href="<?php echo e(route('public.pricing')); ?>" class="block text-gray-700 font-medium text-lg py-3 border-b border-gray-200 hover:text-sky-600 transition-colors <?php echo e(request()->routeIs('public.pricing*') ? 'text-sky-600 font-semibold' : ''); ?>">
