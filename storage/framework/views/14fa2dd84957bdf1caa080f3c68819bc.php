...
<body class="bg-slate-950">
    ...
    <?php $whiteboardRole = 'student'; ?>
    <?php echo $__env->make('partials.live-whiteboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        ...
        const options = {
            ...
            interfaceConfigOverwrite: {
                TOOLBAR_BUTTONS: [
                    ...
                    <?php if($liveSession->allow_screen_share): ?>
                    'desktop',
                    <?php endif; ?>
                ],
        ...
        setInterval(async function() {
            try {
                const res = await fetch('<?php echo e(route("student.live-sessions.status", $liveSession)); ?>', {
