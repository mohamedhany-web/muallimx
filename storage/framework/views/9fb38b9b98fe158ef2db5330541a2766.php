                ...
                <div class="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                            ...
                            <span class="text-xs font-semibold text-slate-600 whitespace-nowrap"><?php echo e($completedLessons ?? 0); ?>/<?php echo e($totalLessons ?? 0); ?></span>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden sticky top-4">
                <div class="p-4 border-b border-slate-200">
                    ...
                    <div class="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-slate-50 border border-slate-200 mb-3">
                        ...
                        <span class="text-[10px] font-bold text-gray-600 whitespace-nowrap"><?php echo e($completedLessons ?? 0); ?>/<?php echo e($totalLessons ?? 0); ?></span>
                        <span class="text-[10px] font-bold text-sky-600"><?php echo e(number_format((float)($progress ?? 0), 0)); ?>%</span>
                    </div>
        ...
        trackLessonProgress(lessonId) {
            ...
            this.progressInterval = setInterval(async () => {
                try {
                    ...
                    await fetch(`<?php echo e(route('my-courses.lesson.progress', [$course, ':lessonId'])); ?>`.replace(':lessonId', lessonId), {
                        method: 'POST',
                        headers: {
