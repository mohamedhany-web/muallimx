                                    ...
                                    <div class="flex items-center gap-4 flex-wrap">
                                        ...
                                        <div class="flex items-center gap-2 text-sm font-bold text-blue-600 flex-wrap">
                                            ...
                                            <?php if($course->hasPromotionalPrice()): ?>
                                                <span class="text-xs text-slate-500 line-through font-semibold tabular-nums"><?php echo e(number_format($course->listPriceAmount(), 0)); ?> <?php echo e(__('public.currency_egp')); ?></span>
                                            <?php endif; ?>
                                            <span class="tabular-nums"><?php echo e(number_format($course->effectivePurchasePrice(), 0)); ?> <?php echo e(__('public.currency_egp')); ?></span>
                                        </div>
                                        <?php else: ?>
                    ...
                    <div class="p-6 bg-white flex-grow flex flex-col">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                            <div>
                                ...
                                <span class="text-sm text-gray-500"><?php echo e(__('public.currency_egp')); ?></span>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\public\learning-path-show.blade.php ENDPATH**/ ?>