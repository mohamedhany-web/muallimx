...
<body class="bg-slate-950">
    ...
    <header class="h-[72px] bg-gradient-to-l from-slate-900 to-slate-800 border-b border-slate-700/50 flex items-center justify-between px-4 sm:px-6 shadow-lg">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('student.classroom.index')); ?>" class="flex items-center gap-2 text-slate-300 hover:text-white transition-colors">
        ...
        <div class="flex items-center gap-2">
            ...
            <form method="POST" action="<?php echo e(route('student.classroom.end', $meeting)); ?>" class="inline" onsubmit="return confirm('إنهاء الاجتماع للجميع؟');">
                <?php echo csrf_field(); ?>
    ...
    <main id="jitsi-container" role="application" aria-label="غرفة الاجتماع">
        ...
        <div id="jitsi-error" class="hidden flex flex-col items-center justify-center h-full p-6 text-center max-w-lg mx-auto">
            ...
            <p class="text-slate-400 text-sm mb-4">المتصفح لم يستطع الاتصال بنطاق السيرفر <strong class="text-slate-300"><?php echo e($jitsiDomain); ?></strong>. تحقق من أن السيرفر يعمل ومتاح من جهازك (حتى على اللوكل يجب أن يكون النطاق يُحمّل من المتصفح).</p>
    ...
    <script>
        (function() {
            ...
            function showError() {
                ...
                if (errorEl) { errorEl.classList.remove('hidden'); errorEl.classList.add('flex'); }
            }
            ...
            function initJitsi() {
                ...
                try {
                    ...
                    api.addEventListener('readyToClose', function() {
                        window.location.href = '<?php echo e(route("student.classroom.index")); ?>';
                    });
