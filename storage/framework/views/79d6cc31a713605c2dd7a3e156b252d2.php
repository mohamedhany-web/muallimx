...
<head>
    ...
    <link href="<?php echo e(asset('css/classroom-meetline.css')); ?>" rel="stylesheet">
    <style>
...
<div class="mx-ml-shell">
    ...
    <header class="mx-ml-top">
        <div class="flex items-center gap-2 min-w-0 flex-1">
            <a href="<?php echo e($roomExitUrl); ?>" class="shrink-0 inline-flex items-center justify-center w-9 h-9 rounded-lg border border-[#e9e9e9] bg-white text-[#0065fd] hover:bg-[#eef5ff]" title="خروج">
                <i class="fas fa-arrow-right"></i>
            </a>
            <h1 class="mx-ml-title truncate"><?php echo e($meeting->title ?: ('غرفة ' . $meeting->code)); ?></h1>
        ...
        <div class="flex items-center gap-2 shrink-0">
            <span class="hidden sm:inline text-[11px] text-[#717171] px-2 py-1 rounded-lg border border-[#e9e9e9] bg-white">حد الطلاب: <?php echo e((int) ($meeting->max_participants ?? 25)); ?></span>
            ...
            <div class="mx-ml-record-chip" title="الوقت المتبقي حسب الباقة">
                ...
                <span id="meeting-timer-chip"><?php echo e((int) $effectiveDurationMinutes); ?>:00</span>
                <span id="meeting-timer-chip-mobile" class="sr-only"><?php echo e((int) $effectiveDurationMinutes); ?> د</span>
            </div>
        ...
        <main id="jitsi-container" class="flex-1 min-h-0 relative w-full h-full" role="application" aria-label="غرفة الاجتماع">
            ...
            <div id="jitsi-error" class="hidden flex-col items-center justify-center h-full p-6 text-center max-w-lg mx-auto" style="display: none;">
                ...
                <ul class="text-right text-slate-400 text-sm mb-4 list-none space-y-1">
                    ...
                    <li>• جرّب فتح <a href="https://<?php echo e($jitsiDomain); ?>/external_api.js" target="_blank" rel="noopener" class="text-cyan-400 hover:underline">هذا الرابط</a> في تاب جديد.</li>
                </ul>
                <a href="https://<?php echo e($jitsiDomain); ?>/<?php echo e($meeting->room_name); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0065fd] hover:bg-[#005bc5] text-white font-semibold transition-colors">
    ...
    <div class="mx-ml-dock" dir="ltr">
        <button type="button" id="btn-classroom-copy-join" class="mx-ml-code-pill" title="نسخ رابط الانضمام" data-join-url="<?php echo e(url('classroom/join/' . $meeting->code)); ?>">
            <i class="fas fa-link text-[10px] btn-copy-join-ic me-1"></i>
            <span class="btn-copy-join-tx font-mono"><?php echo e($meeting->code); ?></span>
            <span class="btn-copy-join-tx-sm hidden" aria-hidden="true"><?php echo e($meeting->code); ?></span>
        </button>
            ...
            <div class="relative shrink-0" id="pkg-features-dd-wrap">
                ...
                <div id="pkg-features-dd-panel" class="pkg-features-dd-panel-inner hidden w-[min(100vw-2rem,19.5rem)] rounded-xl border border-[#e9e9e9] bg-white overflow-hidden" role="menu">
                    <div class="px-3 py-2.5 border-b border-[#e9e9e9] bg-[#f3f4f6]">
                        ...
                        <p class="text-[11px] text-[#717171] m-0 mt-0.5"><?php echo e($subscriptionPackageLabel); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="max-h-[min(58vh,20rem)] overflow-y-auto py-1.5 px-1">
                        ...
                        <a href="<?php echo e($item['url']); ?>" target="_blank" rel="noopener noreferrer" role="menuitem" class="group flex items-center gap-3 px-2.5 py-2 mx-0.5 rounded-lg text-[#171717] hover:bg-[#eef5ff] transition-colors">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg <?php echo e($item['icon_bg']); ?> <?php echo e($item['icon_text']); ?>">
                                <i class="fas <?php echo e($item['icon']); ?> text-sm"></i>
                            </span>
                            <span class="min-w-0 flex-1 text-sm font-medium text-right"><?php echo e($item['label']); ?></span>
                        </a>
    ...
    <?php echo $__env->make('partials.mx-classroom-wb-sync', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php
    ...
    <script>
        (function() {
            ...
            var mxPipUrl = <?php echo json_encode(route(($useInstructorRoutes ?? false) ? 'instructor.classroom.room.pip' : 'student.classroom.room.pip', $meeting)); ?>;
            ...
            var whiteboardSceneGetUrl = '<?php echo e(route($rp . 'classroom.whiteboard-scene', $meeting)); ?>';
            var whiteboardScenePostUrl = '<?php echo e(route($rp . 'classroom.whiteboard-scene.push', $meeting)); ?>';
            var hostWbSync = null;
