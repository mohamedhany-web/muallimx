...
<head>
    ...
    <title>403 - <?php echo e(__('errors.403_title')); ?> | Mindlytics</title>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 lg:py-20">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center fade-in-up" style="animation-delay: 0.5s;">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-red-600 to-pink-500 text-white px-8 py-4 rounded-full font-bold text-base shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
