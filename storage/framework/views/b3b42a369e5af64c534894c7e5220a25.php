            ...
            <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="level" id="level" class="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors">
                        ...
                        <option value="beginner" <?php echo e(request('level') == 'beginner' ? 'selected' : ''); ?>>مبتدئ</option>
                        <option value="intermediate" <?php echo e(request('level') == 'intermediate' ? 'selected' : ''); ?>>متوسط</option>
                        <option value="advanced" <?php echo e(request('level') == 'advanced' ? 'selected' : ''); ?>>متقدم</option>
                    </select>
                </div>
                <div>
