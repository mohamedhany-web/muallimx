...
<?php $__env->startSection('title', 'إضافة مجموعة بيانات'); ?>
<?php $__env->startSection('header', 'إضافة مجموعة بيانات'); ?>

<?php $__env->startSection('content'); ?>
<div class="w-full">
    <form action="<?php echo e(route('admin.community.datasets.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5" placeholder="وصف المجموعة، المصدر، الأعمدة أو طريقة الاستخدام..."
                                      class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-colors resize-y min-h-[120px]"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="file_size" id="file_size" value="<?php echo e(old('file_size')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/admin/community/datasets/create.blade.php ENDPATH**/ ?>