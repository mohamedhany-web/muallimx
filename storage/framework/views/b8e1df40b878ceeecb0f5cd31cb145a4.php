...
<body class="bg-slate-950 text-white">
    ...
    <script>
        ...
        const wbSceneGetUrl = <?php echo json_encode(route('classroom.join.whiteboard-scene', $code), 512) ?>;
        const wbScenePostUrl = <?php echo json_encode(route('classroom.join.whiteboard-scene.push', $code), 512) ?>;
        const mxExcalidrawBases = <?php echo json_encode($mxExBases); ?>;
        let api = null;
        let joinToken = null;
