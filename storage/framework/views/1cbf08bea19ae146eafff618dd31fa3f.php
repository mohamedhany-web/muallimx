            ...
            <header class="sticky top-0 z-30 flex-shrink-0 flex h-14 sm:h-16 bg-gradient-to-r from-slate-50 via-blue-50 to-slate-100 shadow-lg border-b border-slate-200/50 backdrop-blur-sm">
                ...
                <div class="flex-1 px-3 sm:px-6 flex justify-between items-center gap-2">
                    ...
                    <div class="flex items-center gap-2 sm:gap-4">
                        ...
                        ?>
                        <div class="relative"
                             x-data="employeeNavNotifications(<?php echo e(\Illuminate\Support\Js::from($empNavBellConfig)); ?>)"
                            ...
                            <button type="button"
                                    ...
                                    aria-label="<?php echo e($empRtl ? 'الإشعارات' : 'Notifications'); ?>">
                                <i class="fas fa-bell text-lg"></i>
                                <span x-show="unread > 0" x-cloak
                                      class="absolute -top-0.5 <?php echo e($empRtl ? '-left-0.5' : '-right-0.5'); ?> min-w-[18px] h-[18px] bg-rose-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center ring-2 ring-white dark:ring-slate-800 px-1"
                                      x-text="unread > 9 ? '9+' : unread"></span>
                            </button>
                            <div x-show="openNotif" x-cloak
                                 x-transition
                                 class="absolute <?php echo e($empRtl ? 'right-0' : 'left-0'); ?> mt-2 w-80 max-h-[420px] overflow-hidden rounded-xl bg-white dark:bg-slate-800 shadow-xl border border-gray-200 dark:border-slate-600 z-50">
                                <div class="px-4 py-3 border-b border-gray-100 dark:border-slate-600 flex items-center justify-between bg-slate-50/80 dark:bg-slate-700/50">
                                    <div class="min-w-0 flex-1">
                                        <p class="text-sm font-bold text-gray-900 dark:text-slate-100 flex items-center gap-2">
                                            ...
                                            <?php echo e($empRtl ? 'أحدث الإشعارات' : 'Recent notifications'); ?>

                                        </p>
                                        <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5" x-text="unread > 0 ? ('<?php echo e($empRtl ? 'لديك ' : 'You have '); ?>' + unread + '<?php echo e($empRtl ? ' إشعار غير مقروء' : ' unread'); ?>') : '<?php echo e($empRtl ? 'لا توجد إشعارات جديدة' : 'No new notifications'); ?>'"></p>
                                    </div>
                                    <a href="<?php echo e(route('employee.notifications')); ?>" class="text-xs font-semibold text-sky-600 hover:text-sky-700 shrink-0 ms-2">
                                        <?php echo e($empRtl ? 'عرض الكل' : 'All'); ?>
                                ...
                                <div class="max-h-[320px] overflow-y-auto">
                                    <template x-for="item in items" :key="item.id">
                                        <a :href="item.href"
                                           class="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors border-b border-gray-50 dark:border-slate-600 last:border-b-0">
                                            ...
                                            <div class="flex-1 min-w-0 <?php echo e($empRtl ? 'text-right' : 'text-left'); ?>">
                                    ...
                                    <div x-show="items.length === 0" class="px-4 py-6 text-center text-xs text-gray-500 dark:text-slate-400">
                                        <p><?php echo e($empRtl ? 'لا توجد إشعارات جديدة' : 'No new notifications'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                 ...
                                 x-transition
                                 class="absolute <?php echo e($empRtl ? 'right-0' : 'left-0'); ?> mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
