...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="rounded-xl bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-600 p-3 text-xs text-slate-600 dark:text-slate-300 space-y-1">
            <p>استهلاك الشهر الحالي: <?php echo e(number_format($usedMeetingsThisMonth)); ?> من <?php echo e(number_format($limits['classroom_meetings_per_month'])); ?>.
            المتبقي: <span class="font-bold"><?php echo e(number_format($remainingMeetingsThisMonth)); ?></span></p>
            <?php if(!empty($fixedJoinUrl)): ?>
                <p>رابطك الثابت للطلاب (لا يتغير): <span class="font-mono text-[11px]" dir="ltr"><?php echo e($fixedJoinUrl); ?></span></p>
            <?php endif; ?>
            <?php if($remainingMeetingsThisMonth <= 0): ?>
