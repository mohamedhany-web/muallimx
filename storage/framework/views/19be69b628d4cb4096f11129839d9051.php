    ...
    <section class="py-12 md:py-16 bg-gradient-to-b from-gray-50 via-white to-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-12 auto-rows-fr">
                ...
                ?>
                <div class="course-card rounded-3xl overflow-hidden shadow-xl fade-in-up group h-full" style="animation-delay: <?php echo e($index * 0.1); ?>s;"
                    ...
                    <div class="h-48 lg:h-44 bg-gradient-to-br from-blue-600 via-blue-500 to-green-500 flex items-center justify-center relative course-image overflow-hidden flex-shrink-0">
                        <?php if($hasThumbnail && $imageUrl): ?>
                            <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($course['title'] ?? __('public.course_fallback')); ?>" class="w-full h-full object-cover absolute inset-0 z-0" style="display: block !important; position: absolute !important; top: 0 !important; left: 0 !important; width: 100% !important; height: 100% !important; object-fit: cover !important; z-index: 0 !important;" onload="console.log('Image loaded: <?php echo e($imageUrl); ?>');" onerror="console.error('Image failed to load: <?php echo e($imageUrl); ?>'); this.style.display='none';">
                        <?php else: ?>
                        ...
                        <div class="absolute bottom-3 right-3 bg-white/20 backdrop-blur-md rounded-full px-2 py-1 z-20">
                            <span class="text-white text-[10px] font-bold flex items-center gap-1">
                                ...
                                <span><?php echo e($course['lessons_count'] ?? 0); ?> <?php echo e(__('public.lesson_single')); ?></span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-white flex-grow flex flex-col justify-between">
                        ...
                        <h3 class="text-lg lg:text-xl font-black text-gray-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors duration-300 leading-tight min-h-[3.5rem]"><?php echo e($course['title'] ?? __('public.no_title_fallback')); ?></h3>
                        
                        <p class="text-gray-600 text-xs lg:text-sm mb-3 line-clamp-2 leading-relaxed min-h-[3rem]">
                            <?php echo e(Str::limit($course['description'] ?? __('public.course_description_fallback'), 80)); ?>
