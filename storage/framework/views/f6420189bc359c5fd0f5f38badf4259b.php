<?php $__env->startSection('title', 'صلاحيات المستخدمين - ' . config('app.name', 'Muallimx')); ?>
<?php $__env->startSection('header', 'صلاحيات المستخدمين'); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($allPermissions->flatten()->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($allPermissions->count()); ?></p>
                </div>
                        ...
                        <tr class="hover:bg-gray-50">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <?php if($user->profile_image): ?>
                                            <img class="h-10 w-10 rounded-full" src="<?php echo e($user->profile_image_url); ?>" alt="<?php echo e($user->name); ?>">
                                        <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-900">
                                    <?php echo e($directPermissions->count()); ?> صلاحية
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-bold text-blue-600">
                                    <?php echo e($totalPermissions->count()); ?> صلاحية
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="<?php echo e(route('admin.user-permissions.show', $user)); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views/admin/user-permissions/index.blade.php ENDPATH**/ ?>