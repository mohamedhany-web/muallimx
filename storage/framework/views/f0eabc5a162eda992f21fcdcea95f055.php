...
<head>
    ...
    <?php $adminFavicon = ! empty($adminPanelLogoUrl) ? $adminPanelLogoUrl : null; ?>
    <?php if($adminFavicon): ?>
    <link rel="icon" type="image/png" href="<?php echo e($adminFavicon); ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e($adminFavicon); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e($adminFavicon); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e($adminFavicon); ?>">
    <?php else: ?>
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    ...
                    <div x-show="open" x-cloak
                        ...
                        <div class="py-1.5">
                            ...
                            <a href="<?php echo e($adminNavSettingsUrl); ?>" class="flex items-center gap-3 px-4 py-2.5 text-[13px] text-slate-600 hover:bg-slate-50 hover:text-slate-800 dark:hover:bg-slate-700/50 dark:text-slate-300 transition-colors">
