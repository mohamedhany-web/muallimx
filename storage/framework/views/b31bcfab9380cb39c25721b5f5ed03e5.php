...
<div class="space-y-5">
    ...
    <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
        ...
        <div class="flex flex-wrap gap-1">
            <?php $__currentLoopData = $sidebarGuide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $active = in_array($g['perm'], $activePermNames); ?>
            <span title="<?php echo e($g['section']); ?>" class="inline-flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded border font-medium cursor-help
                         <?php echo e($active ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-400 border-gray-200'); ?>">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <button type="button" data-group="g<?php echo e($loop->index); ?>" onclick="toggleGroup(this)"
                                    class="text-xs text-indigo-500 hover:text-indigo-700 font-medium flex-shrink-0">
                                تحديد
                            </button>
                        </div>
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-1.5" id="g<?php echo e($loop->index); ?>">
