...
<?php $__env->startSection('meta_description', __('public.legal_privacy_meta', ['brand' => $brand])); ?>
<?php $__env->startSection('meta_keywords', __('public.legal_privacy_keywords', ['brand' => $brand])); ?>
<?php $__env->startSection('canonical_url', url('/privacy')); ?>
    ...
    <div class="w-full max-w-[1200px] mx-auto px-6 sm:px-8 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-8 mb-8 max-w-3xl mx-auto">
                <?php echo e(__('public.legal_privacy_hero_sub')); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                ...
                <a href="<?php echo e(route('public.terms')); ?>" class="inline-flex items-center justify-center gap-2 rounded-2xl font-bold px-7 py-3.5 border-2 transition-all hover:opacity-95 text-white" style="background:#283593;border-color:#283593">
        ...
        <div class="rounded-[28px] border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-[0_20px_44px_-26px_rgba(31,42,122,.28)] px-6 sm:px-10 py-8 sm:py-10">
            <div class="flex flex-col sm:flex-row sm:items-start gap-6">
                ...
                <p class="text-slate-700 dark:text-slate-200 text-base md:text-lg leading-[1.9] flex-1">
                    <?php echo nl2br(e(__('public.legal_privacy_intro', ['brand' => $brand]))); ?>
    ...
    <div class="w-full max-w-[1200px] mx-auto px-6 sm:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
            ...
            <?php
                ...
                $tintCream = $i === 4;
            ?>
            <article class="privacy-home-card rounded-2xl p-6 sm:p-7 flex flex-col h-full <?php if($tintRose): ?> bg-[#FFE5F7]/90 dark:bg-slate-800 <?php elseif($tintCream): ?> bg-[#fffbea] dark:bg-slate-800 <?php else: ?> bg-white dark:bg-slate-800 <?php endif; ?> <?php if($i === 7): ?> md:col-span-2 <?php endif; ?>">
                ...
                <p class="text-slate-600 dark:text-slate-400 leading-relaxed text-sm sm:text-base flex-1 <?php if($i === 7): ?> max-w-4xl <?php endif; ?>">
                    <?php echo nl2br(e(__('public.legal_privacy_s'.$i.'_body', ['brand' => $brand]))); ?>
...
<section class="pt-14 sm:pt-16 pb-12 sm:pb-14" style="background:linear-gradient(180deg,#f4f7ff 0%,#ffffff 100%)">
    <div class="w-full max-w-[1200px] mx-auto px-6 sm:px-8">
        <div class="rounded-[28px] border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-[0_20px_44px_-26px_rgba(31,42,122,.28)] px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h3 class="text-2xl sm:text-3xl md:text-4xl font-black mb-3 text-[#1F2A7A] dark:text-white" style="font-family:Tajawal,Cairo,sans-serif"><?php echo e(__('public.legal_privacy_cta_title')); ?></h3>
            <p class="text-slate-600 dark:text-slate-400 text-base sm:text-lg max-w-2xl mx-auto leading-8 mb-8">
                <?php echo e(__('public.legal_privacy_cta_desc')); ?>
