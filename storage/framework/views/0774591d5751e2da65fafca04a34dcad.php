...
<div class="space-y-6">
    <?php if(!empty($certificate->pdf_path)): ?>
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 no-print">
            <div class="flex items-center justify-between flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('student.certificates.file', $certificate)); ?>"
    ...
    <div class="text-center space-x-4 no-print">
        ...
        <a href="<?php echo e(route('student.certificates.index')); ?>" class="inline-flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-800 px-8 py-3 rounded-xl font-semibold transition-all duration-300">
