...
<body class="bg-white text-navy-950 antialiased font-body">
    ...
    <main class="flex-1">
        ...
        <section class="relative overflow-hidden bg-navy-950 noise pt-24 pb-16 md:pb-24">
            ...
            <div class="absolute bottom-[-10%] <?php echo e($isRtl?'right-[-5%]':'left-[-5%]'); ?> w-[400px] h-[400px] rounded-full bg-blue-600/8 blur-[100px]"></div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full">
                ...
                <nav class="reveal text-sm text-slate-400/80 mb-8 flex items-center gap-2 flex-wrap">
                    ...
                    <a href="<?php echo e(route('public.courses')); ?>" class="hover:text-white transition-colors"><?php echo e(__('public.courses')); ?></a>
                    <i class="fas fa-chevron-<?php echo e($isRtl?'left':'right'); ?> text-[8px] text-slate-600"></i>
                    <span class="text-white/90 font-medium"><?php echo e(Str::limit($course->title ?? '', 40)); ?></span>
                </nav>
                    ...
                    <div class="lg:col-span-3 reveal">
                            ...
                            <div class="flex items-center gap-3 mb-8">
                                ...
                                <div>
                                    ...
                                    <?php if(\App\Models\InstructorProfile::where('user_id', $course->instructor->id)->where('status', 'approved')->exists()): ?>
                                        <a href="<?php echo e(route('public.instructors.show', $course->instructor)); ?>" class="text-white font-bold hover:text-brand-300 transition-colors"><?php echo e($course->instructor->name); ?></a>
                                    <?php else: ?>
                                        <span class="text-white font-bold"><?php echo e($course->instructor->name); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <a href="<?php echo e(route('public.courses')); ?>" class="btn-outline inline-flex items-center gap-2 bg-white/[0.06] border-2 border-white/[0.15] text-white hover:bg-white/[0.12] px-6 py-3.5 rounded-2xl font-bold text-base backdrop-blur-sm">
                        ...
                        <div class="glass-dark rounded-3xl p-6 sm:p-7 shadow-2xl">
                            <div class="text-center mb-5">
                                <?php if(($course->price ?? 0) > 0): ?>
                                    <div class="text-4xl sm:text-5xl font-black text-white mb-1"><?php echo e(number_format($course->price, 0)); ?></div>
                                    <div class="text-slate-400 text-sm font-medium"><?php echo e(__('public.currency_egp')); ?></div>
                                <?php else: ?>
    ...
    <footer style="background:#283593" class="text-white">
        <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-12 pb-8">
            <div class="grid md:grid-cols-4 gap-8 pb-8 border-b border-white/15">
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="w-11 h-11 rounded-xl bg-brand-500 text-white font-black flex items-center justify-center">M</span>
                        <div>
