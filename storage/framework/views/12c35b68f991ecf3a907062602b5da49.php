<?php $__env->startSection('title', 'تعديل الاتفاقية - ' . config('app.name', 'Muallimx')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="type" id="type" required class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 focus:ring-2 focus:ring-sky-500 focus:border-sky-400 transition-all">
                        ...
                        <option value="consultation_session" <?php echo e($effectiveType == 'consultation_session' ? 'selected' : ''); ?>>استشارات</option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\agreements\edit.blade.php ENDPATH**/ ?>