                                        ...
                                        <div class="text-slate-800 dark:text-slate-100 font-black text-lg tabular-nums">
                                            <?php if(!$course->is_free && $course->effectivePurchasePrice() > 0): ?>
                                                <?php if($course->hasPromotionalPrice()): ?>
                                                    <span class="block text-sm text-slate-400 line-through font-semibold"><?php echo e(number_format($course->listPriceAmount(), 2)); ?> ج.م</span>
                                                <?php endif; ?>
                                                <?php echo e(number_format($course->effectivePurchasePrice(), 2)); ?> ج.م
                                            <?php else: ?>
