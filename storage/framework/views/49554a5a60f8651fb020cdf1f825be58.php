...
<div class="space-y-6">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                <div class="flex-1 min-w-0">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#FFE5F7] dark:bg-brand-900/30 text-[#283593] dark:text-brand-300 text-xs font-bold mb-3 border border-[#f5c7e8] dark:border-brand-800/50">
                        ...
                        <?php echo e(__('student.teacher_hub_badge')); ?>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm max-w-2xl leading-relaxed">
                        <?php if(empty($activeSubscription)): ?>
                            <?php echo e(__('student.dashboard_subtitle_no_subscription')); ?>

                        <?php elseif(!empty($isFreeTrial)): ?>
                            <?php echo e(__('student.dashboard_subtitle_free_trial')); ?>

                        <?php else: ?>
                            <?php echo e(__('student.dashboard_subtitle_teacher')); ?>
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-2">
                        <a href="<?php echo e($pricingUrl); ?>"
                           class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#FB5607] hover:bg-[#e04d00] text-white text-sm font-bold shadow-md shadow-[#FB5607]/25 transition-colors">
                            <i class="fas fa-<?php echo e(empty($activeSubscription) ? 'bolt' : 'sync-alt'); ?> text-xs"></i>
                            <?php echo e(empty($activeSubscription) ? __('student.subscribe_now') : __('student.renew_or_upgrade')); ?>
                        ...
                        <?php if($activeSubscription && Route::has('student.my-subscription')): ?>
                            <a href="<?php echo e(route('student.my-subscription')); ?>"
                               class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                                ...
                                <?php echo e(__('student.my_subscription_short')); ?>
                ...
                <div class="shrink-0 rounded-2xl border border-slate-200 dark:border-slate-600 bg-white/80 dark:bg-slate-900/60 px-5 py-4 min-w-[200px]">
                    <p class="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1"><?php echo e(__('student.features_unlocked_label')); ?></p>
                    <p class="text-3xl font-black text-[#283593] dark:text-indigo-300 tabular-nums">
                        <?php echo e($stats['features_unlocked']); ?><span class="text-lg text-slate-400">/<?php echo e($stats['features_total']); ?></span>
                    </p>
                    <div class="mt-3 h-2 rounded-full bg-slate-100 dark:bg-slate-700 overflow-hidden">
                        <div class="h-full rounded-full bg-gradient-to-l from-[#283593] to-[#FB5607]" style="width: <?php echo e($unlockedPct); ?>%"></div>
                    </div>
                    <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-2"><?php echo e(__('student.features_unlocked_hint')); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="rounded-2xl border-2 border-[#FB5607]/30 bg-gradient-to-l from-[#FFF7ED] via-white to-[#FFE5F7]/40 dark:from-slate-800/90 dark:via-slate-800/95 dark:to-slate-900/90 dark:border-amber-500/30 p-5 sm:p-6">
            <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                <div class="flex items-start gap-4 flex-1">
                    ...
                    <div>
                        <h2 class="font-heading text-lg font-black text-slate-800 dark:text-slate-100"><?php echo e(__('student.subscribe_cta_title')); ?></h2>
                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1 leading-relaxed"><?php echo e(__('student.subscribe_cta_description')); ?></p>
                        <p class="text-xs text-amber-700 dark:text-amber-300 font-semibold mt-2"><?php echo e(__('student.locked_features_hint')); ?></p>
                    </div>
                </div>
                <a href="<?php echo e($pricingUrl); ?>" class="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#FB5607] hover:bg-[#e04d00] text-white text-sm font-bold shrink-0">
                    <i class="fas fa-bolt"></i> <?php echo e(__('student.choose_package')); ?>

                </a>
            </div>
        </div>
    <?php else: ?>
        <div class="rounded-2xl bg-white dark:bg-slate-800/95 border border-slate-200/80 dark:border-slate-700 overflow-hidden <?php echo e(!empty($renewHighlight) ? 'ring-2 ring-[#FB5607]/40' : ''); ?>">
            <div class="p-4 sm:p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-gradient-to-l from-[#FFE5F7]/80 to-white dark:from-slate-800/90 dark:to-slate-900/90">
                <div class="flex items-start gap-3 min-w-0">
                    <span class="w-11 h-11 rounded-xl <?php echo e(!empty($isFreeTrial) ? 'bg-amber-100 text-amber-700' : 'bg-[#FFE5F7] text-[#283593]'); ?> dark:bg-indigo-900/40 dark:text-indigo-300 flex items-center justify-center shrink-0">
                        <i class="fas <?php echo e(!empty($isFreeTrial) ? 'fa-gift' : 'fa-layer-group'); ?>"></i>
                    </span>
                    <div class="min-w-0">
                        <h2 class="font-bold text-slate-800 dark:text-slate-100 truncate"><?php echo e($activeSubscription->plan_name); ?></h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                            ...
                            <?php if($activeSubscription->end_date): ?>
                                · <?php echo e(__('student.ends_on')); ?> <?php echo e($activeSubscription->end_date->format('Y-m-d')); ?>

                            <?php endif; ?>
                            <?php if($daysRemaining !== null): ?>
                                · <span class="font-semibold <?php echo e($daysRemaining <= 3 ? 'text-rose-600' : 'text-emerald-600'); ?>"><?php echo e(__('student.days_left', ['days' => $daysRemaining])); ?></span>
                            <?php endif; ?>
                        </p>
                        <?php if(!empty($isFreeTrial)): ?>
                            <p class="text-xs text-amber-700 dark:text-amber-300 font-semibold mt-1.5">
                                <?php echo e(__('student.free_trial_banner', ['used' => $daysUsed ?? 0])); ?>
                    ...
                    <?php if(!empty($showRenewCta)): ?>
                        <a href="<?php echo e($pricingUrl); ?>"
                           class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#FB5607] hover:bg-[#e04d00] text-white text-sm font-bold shadow-md shadow-[#FB5607]/20">
                            ...
                            <?php echo e(!empty($isFreeTrial) ? __('student.upgrade_after_trial') : __('student.renew_package')); ?>
    ...
    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/95 p-5">
        <h2 class="font-heading text-base font-black text-slate-800 dark:text-slate-100 mb-4"><?php echo e(__('student.getting_started_title')); ?></h2>
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div class="rounded-xl border border-slate-100 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/40 p-4">
                ...
                <p class="text-sm font-bold text-slate-800 dark:text-slate-100"><?php echo e(__('student.step_choose_package')); ?></p>
                <p class="text-xs text-slate-500 mt-1 leading-relaxed"><?php echo e(__('student.step_choose_package_desc')); ?></p>
            </div>
            <div class="rounded-xl border border-slate-100 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/40 p-4">
                ...
                <p class="text-sm font-bold text-slate-800 dark:text-slate-100"><?php echo e(__('student.step_open_features')); ?></p>
                <p class="text-xs text-slate-500 mt-1 leading-relaxed"><?php echo e(__('student.step_open_features_desc')); ?></p>
            </div>
            <div class="rounded-xl border border-slate-100 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/40 p-4">
                ...
                <p class="text-sm font-bold text-slate-800 dark:text-slate-100"><?php echo e(__('student.step_start_teaching')); ?></p>
                <p class="text-xs text-slate-500 mt-1 leading-relaxed"><?php echo e(__('student.step_start_teaching_desc')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div>
        <div class="flex flex-wrap items-end justify-between gap-3 mb-4">
            <div>
                <h2 class="font-heading text-lg sm:text-xl font-black text-slate-800 dark:text-slate-100"><?php echo e(__('student.package_features_title')); ?></h2>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5"><?php echo e(__('student.package_features_subtitle')); ?></p>
            </div>
            <div class="flex items-center gap-3 text-xs font-semibold">
                <span class="inline-flex items-center gap-1.5 text-emerald-700 dark:text-emerald-400"><span class="w-2 h-2 rounded-full bg-emerald-500"></span><?php echo e(__('student.feature_active')); ?></span>
                <span class="inline-flex items-center gap-1.5 text-slate-500"><span class="w-2 h-2 rounded-full bg-slate-300"></span><?php echo e(__('student.feature_locked')); ?></span>
            </div>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
            <?php $__currentLoopData = $packageFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($feature['url']); ?>" class="td-feature <?php echo e($feature['unlocked'] ? '' : 'is-locked'); ?> group">
                    <div class="flex items-start justify-between gap-3 mb-3">
                        <span class="w-11 h-11 rounded-xl flex items-center justify-center <?php echo e($feature['icon_bg']); ?> <?php echo e($feature['icon_text']); ?>">
                            <i class="fas <?php echo e($feature['icon']); ?>"></i>
                        </span>
                        <?php if($feature['unlocked']): ?>
                            <span class="inline-flex items-center gap-1 text-[10px] font-black px-2 py-1 rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-800">
                                <i class="fas fa-check"></i> <?php echo e(__('student.feature_active')); ?>
                        ...
                        <?php else: ?>
                            <span class="inline-flex items-center gap-1 text-[10px] font-black px-2 py-1 rounded-lg bg-slate-100 text-slate-600 border border-slate-200 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600">
                                <i class="fas fa-lock"></i> <?php echo e(__('student.feature_locked')); ?>
                    ...
                    <div class="mt-3 pt-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between text-xs font-bold">
                        <?php if($feature['unlocked']): ?>
                            <span class="text-[#283593] dark:text-indigo-300"><?php echo e(__('student.open_feature')); ?></span>
                        <?php else: ?>
                            <span class="text-[#FB5607]"><?php echo e(__('student.unlock_via_package')); ?></span>
                        <?php endif; ?>
