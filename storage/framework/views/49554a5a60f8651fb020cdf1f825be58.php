        ...
        <div class="bg-gradient-to-l from-brand-50 via-white to-white dark:from-slate-800/80 dark:via-slate-800/90 dark:to-slate-900/90 p-5 sm:p-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 flex-shrink-0">
                    ...
                    <a href="<?php echo e(route('public.courses')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold shadow-md shadow-indigo-500/20 transition-colors order-2 sm:order-1">
                    ...
                    <div class="relative flex items-center justify-center order-1 sm:order-2">
                        ...
                        <span class="absolute inset-0 flex items-center justify-center font-heading text-lg font-black text-brand-700 dark:text-brand-300"><?php echo e($progress); ?>%</span>
                    </div>
            ...
            <div class="section-card">
                <div class="flex items-center justify-between p-5 pb-0">
                    ...
                    <div class="flex items-center gap-3 flex-wrap justify-end">
                        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'student.view.courses')): ?>
                        <a href="<?php echo e(route('public.courses')); ?>" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 text-sm font-semibold flex items-center gap-1 transition-colors">
                ...
                <div class="p-5 space-y-1">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-12">
                            ...
                            <a href="<?php echo e(route('public.courses')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-brand-500 to-brand-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-brand-500/25 hover:shadow-xl transition-all">
