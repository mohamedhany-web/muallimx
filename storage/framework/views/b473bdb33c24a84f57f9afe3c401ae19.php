        ...
        <section class="py-20 md:py-28 bg-white">
            <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="reveal stagger-<?php echo e(min($idx + 1, 4)); ?> card-hover group rounded-3xl bg-white border border-slate-100 overflow-hidden shadow-sm flex flex-col">
                    <a href="<?php echo e(route('public.instructors.show', $p->user)); ?>" class="block flex-1 min-h-0">
                        ...
                        <div class="relative aspect-[4/3] bg-gradient-to-br from-brand-500 via-blue-500 to-navy-700 overflow-hidden">
                            ...
                            <span class="absolute top-3 <?php echo e($isRtl?'left':'right'); ?>-3 px-3 py-1.5 rounded-full bg-amber-500/95 text-white text-[11px] font-bold flex items-center gap-1.5 shadow-lg backdrop-blur-sm">
                        ...
                        <div class="px-5 sm:px-6 pb-5 pt-1 border-t border-slate-50">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                <span class="text-[11px] text-slate-500 font-medium">استشارة — <strong class="text-navy-950"><?php echo e(number_format($p->effectiveConsultationPriceEgp(), 2)); ?></strong> ج.م</span>
