                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl cursor-pointer hover:bg-sky-50/50 border border-slate-200 hover:border-sky-200 transition-colors">
                        <input type="checkbox" name="has_assignment" value="1" <?php echo e(old('has_assignment') ? 'checked' : ''); ?>
                               ...
                               class="w-5 h-5 text-sky-600 border-slate-300 rounded focus:ring-sky-500">
                        <div>
                            <div class="font-bold text-slate-800"><?php echo e(__('instructor.has_assignment')); ?></div>
                            <div class="text-sm text-slate-600"><?php echo e(__('instructor.has_assignment_desc')); ?></div>
                        </div>
                    </label>
                    <label class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl cursor-pointer hover:bg-sky-50/50 border border-slate-200 hover:border-sky-200 transition-colors">
                        <input type="checkbox" name="has_evaluation" value="1" <?php echo e(old('has_evaluation') ? 'checked' : ''); ?>
                               ...
                               class="w-5 h-5 text-sky-600 border-slate-300 rounded focus:ring-sky-500">
                        <div>
                            <div class="font-bold text-slate-800"><?php echo e(__('instructor.has_evaluation')); ?></div>
                            <div class="text-sm text-slate-600"><?php echo e(__('instructor.has_evaluation_desc')); ?></div>
                        </div>
                    </label>
                </div>
            </div>
...
function videoPreviewData() {
    return {
        selectedPlatform: '<?php echo e(old('video_platform', '')); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/instructor/lectures/create.blade.php ENDPATH**/ ?>