    ...
    <div class="register-wrapper">
        ...
        <div class="register-mobile-wrap">
            <div class="register-mobile-welcome">
                <h1 class="welcome-title"><?php echo e(__('auth.join_us')); ?></h1>
                <p class="welcome-desc"><?php echo e(__('auth.create_account_desc')); ?></p>
            </div>

            <div class="register-mobile-form-wrap">
                <h2 class="section-title"><?php echo e(__('auth.register')); ?></h2>
                <p class="section-subtitle"><?php echo e(__('auth.register_subtitle')); ?></p>
                ...
                <div class="register-mobile-form-card">
                    <form action="<?php echo e(route('register')); ?>" method="POST">
                        ...
                        <div class="bg-[var(--color-primary-light)] border border-[var(--input-border)] rounded-xl p-2.5 mb-3">
                            <p class="text-xs font-bold text-[var(--text-dark)]"><?php echo e(__('auth.students_only_note')); ?></p>
                        </div>

                        <div class="input-wrap">
                            <label for="name_m"><?php echo e(__('auth.full_name')); ?></label>
                            <div class="relative">
                                <i class="input-icon fas fa-user"></i>
                                <input type="text" name="name" id="name_m" value="<?php echo e(old('name')); ?>" required class="form-input w-full" placeholder="<?php echo e(__('auth.enter_full_name')); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-wrap">
                            <label for="password_m"><?php echo e(__('auth.password')); ?></label>
                            <div class="relative">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-wrap">
                            <label for="password_confirmation_m"><?php echo e(__('auth.password_confirmation')); ?></label>
                            <div class="relative">
                                <i class="input-icon fas fa-lock"></i>
                        ...
                        <div class="flex items-start gap-2 mb-4">
                            ...
                            <label for="terms_m" class="text-xs text-[var(--text-muted)]"><?php echo e(__('auth.agree_terms')); ?> <a href="#" class="link-primary"><?php echo e(__('auth.terms_of_use')); ?></a> <?php echo e(__('auth.and')); ?> <a href="#" class="link-primary"><?php echo e(__('auth.privacy_policy')); ?></a></label>
                        </div>
                        ...
                        <div class="text-center pt-4 mt-4 border-t border-[var(--input-border)]">
                            <p class="text-sm text-[var(--text-muted)] mb-1"><?php echo e(__('auth.already_have_account')); ?></p>
                            <a href="<?php echo e(route('login')); ?>" class="link-primary text-sm inline-flex items-center gap-1">
                                <i class="fas fa-sign-in-alt"></i>
                                <span><?php echo e(__('auth.go_to_login')); ?></span>
                            </a>
                        </div>
                    </form>
                </div>
            ...
            <div class="register-form-section">
                <div class="register-form-wrapper">
                    <h2 class="register-page-title text-2xl md:text-3xl font-black text-[var(--text-dark)] text-center mb-6">
                        <?php echo e(__('auth.register')); ?> <span class="text-[var(--color-primary)]"><?php echo e(config('app.name')); ?></span>
                    </h2>
                    ...
                    <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-2.5 md:space-y-3">
                        ...
                        <div class="bg-[var(--color-primary-light)] border border-[var(--input-border)] rounded-xl p-3 mb-4">
                            <p class="text-sm font-bold text-[var(--text-dark)]"><?php echo e(__('auth.students_only_note')); ?> — <?php echo e(__('auth.register_subtitle')); ?></p>
                        </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       required 
                                       class="form-input w-full px-4 py-3 rounded-xl text-[var(--text-dark)] font-medium <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="phone" class="block text-sm font-bold text-[var(--text-dark)] mb-1.5">
                                    <?php echo e(__('auth.phone_number')); ?>

                                </label>
                                <div class="phone-country-row flex rounded-xl overflow-hidden border border-[var(--input-border)] bg-[var(--input-bg)] transition-all focus-within:border-[var(--color-primary)] focus-within:ring-2 focus-within:ring-[var(--color-primary-light)] <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <select name="country_code" 
                                            ...
                                            dir="ltr"
                                            aria-label="<?php echo e(__('auth.country_code_aria')); ?>">
                                        <?php $__currentLoopData = $phoneCountries ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <input type="tel" 
                                           ...
                                           required 
                                           class="form-input flex-1 min-w-0 px-3 py-2.5 rounded-r-xl rounded-l-none border-0 text-[var(--text-dark)] font-medium text-sm bg-transparent focus:ring-0 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" 
                                           ...
                                           id="password" 
                                           required 
                                           class="form-input w-full px-4 py-3 pr-10 pl-11 rounded-xl text-[var(--text-dark)] font-medium <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="password_confirmation" class="block text-sm font-bold text-[var(--text-dark)] mb-1.5">
                                    <?php echo e(__('auth.password_confirmation')); ?>
...
class="mt-0.5 h-4 w-4 rounded border-[var(--input-border)] text-[var(--color-primary)] focus:ring-[var(--color-primary)]">
                            <label for="terms" class="mr-2 text-sm text-[var(--text-dark)] font-medium leading-tight">
                                ...
                                <a href="#" class="link-primary underline"><?php echo e(__('auth.terms_of_use')); ?></a>
                                <?php echo e(__('auth.and')); ?>

                                <a href="#" class="link-primary underline"><?php echo e(__('auth.privacy_policy')); ?></a>
                            </label>
                        </div>
                        ...
                        <div class="text-center pt-6 mt-6 border-t border-[var(--input-border)]">
                            <p class="text-sm text-[var(--text-muted)] mb-2"><?php echo e(__('auth.already_have_account')); ?></p>
                            <a href="<?php echo e(route('login')); ?>" class="link-primary inline-flex items-center gap-2 text-sm">
                                <i class="fas fa-sign-in-alt"></i>
                                <span><?php echo e(__('auth.go_to_login')); ?></span>
                            </a>
                        </div>
