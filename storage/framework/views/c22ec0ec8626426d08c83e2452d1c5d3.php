...
<div class="space-y-6">
    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200 shadow-sm">
        <h1 class="text-2xl font-bold text-slate-800 mb-1"><?php echo e(__('instructor.profile_branding_title')); ?></h1>
        <p class="text-sm text-slate-500"><?php echo e(__('instructor.personal_branding_desc')); ?></p>
        <div class="mt-3">
    ...
    <form method="POST" action="<?php echo e(route('instructor.personal-branding.update')); ?>" enctype="multipart/form-data" class="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200 shadow-sm space-y-6">
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.profile_photo')); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.intro_title')); ?></label>
            <input type="text" name="headline" value="<?php echo e(old('headline', $profile->headline)); ?>" placeholder="<?php echo e(__('instructor.headline_placeholder')); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.bio')); ?></label>
            <textarea name="bio" rows="5" placeholder="<?php echo e(__('instructor.bio_placeholder')); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm"><?php echo e(old('bio', $profile->bio)); ?></textarea>
            <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.experience')); ?></label>
            <textarea name="experience" rows="10" placeholder="<?php echo e(__('instructor.experience_placeholder')); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm"><?php echo e(old('experience', $profile->experience)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.skills')); ?></label>
            <p class="text-xs text-slate-500 mb-2"><?php echo e(__('instructor.skills_hint')); ?></p>
            <textarea name="skills" rows="5" placeholder="<?php echo e(__('instructor.skills_placeholder')); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm"><?php echo e(old('skills', $profile->skills)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-xs text-slate-500 mt-2"><?php echo e(__('instructor.skills_preview')); ?> (<?php echo e(count($skillsPreview)); ?> <?php echo e(__('instructor.skill_count')); ?>):</p>
            <div class="flex flex-wrap gap-2 mt-1">
                ...
                <span class="inline-flex items-center rounded-lg bg-sky-50 text-sky-700 px-2.5 py-1 text-xs font-medium"><?php echo e($skill); ?></span>
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.linkedin_url')); ?></label>
            ...
            <p class="text-xs text-slate-500 mt-1"><?php echo e(__('instructor.linkedin_optional_hint')); ?></p>
...
unset($__errorArgs, $__bag); ?>
    ...
    <form method="POST" action="<?php echo e(route('instructor.personal-branding.submit')); ?>" class="inline mt-4">
        <?php echo csrf_field(); ?>
        <button type="submit" class="rounded-xl bg-amber-500 text-white px-5 py-2.5 text-sm font-semibold hover:bg-amber-600"><?php echo e(__('instructor.submit_for_review')); ?></button>
    </form>
    <?php endif; ?>
</div>
