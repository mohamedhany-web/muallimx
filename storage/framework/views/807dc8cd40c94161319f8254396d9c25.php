                    ...
                    <div class="rounded-2xl border border-slate-200 shadow-sm overflow-hidden bg-white flex flex-col">
                        <div class="px-5 pt-5 pb-4 bg-gradient-to-br <?php echo e($meta['color']); ?> text-white relative">
                            <div class="absolute top-3 left-3 bg-white/10 text-xs font-semibold px-3 py-1 rounded-full backdrop-blur">
                                <?php echo e($meta['badge']); ?>

                            </div>
                            <h2 class="text-xl font-black mb-1"><?php echo e($meta['title']); ?></h2>
                            <p class="text-xs text-white/80"><?php echo e($meta['subtitle']); ?></p>
                        </div>
                        <div class="p-5 space-y-4 flex-1 flex flex-col">
                            ...
                            <div>
                                ...
                                <select name="plans[<?php echo e($key); ?>][billing_cycle]"
                                    ...
                                    <option value="quarterly" <?php echo e($billingCycle === 'quarterly' ? 'selected' : ''); ?>>ربع سنوي</option>
                                    <option value="yearly" <?php echo e($billingCycle === 'yearly' ? 'selected' : ''); ?>>سنوي</option>
                                </select>
                            </div>
                            ...
                            <div class="border-t border-slate-200 pt-3 mt-auto">
                                ...
                                <div class="space-y-1.5 text-xs text-slate-700">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="library_access"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('library_access', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>مكتبة المناهج التفاعلية الجاهزة</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="ai_tools"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('ai_tools', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>أدوات الذكاء الاصطناعي لإعداد الدروس</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="classroom_access"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('classroom_access', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>استخدام MuallimX Classroom للتدريس</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="zoom_access"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('zoom_access', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>عقد حصص عبر Zoom</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="support"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('support', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>دعم فني للمعلمين</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="teacher_profile"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('teacher_profile', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>إنشاء بروفايل معلم احترافي</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="visible_to_academies"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('visible_to_academies', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>الظهور للأكاديميات داخل المنصة</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="can_apply_opportunities"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('can_apply_opportunities', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>التقديم على فرص التدريس</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="full_ai_suite"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('full_ai_suite', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>أدوات AI كاملة</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="teacher_evaluation"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('teacher_evaluation', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>تقييم المعلم من فريق MuallimX</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="recommended_to_academies"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('recommended_to_academies', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>ترشيح للأكاديميات المناسبة</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="priority_opportunities"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('priority_opportunities', $planFeatures, true) ? 'checked' : ''); ?>>
                                        <span>أولوية في فرص التدريس</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="plans[<?php echo e($key); ?>][features][]" value="direct_support"
                                            class="ml-2 rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                                            <?php echo e(in_array('direct_support', $planFeatures, true) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views/admin/teacher-features/index.blade.php ENDPATH**/ ?>