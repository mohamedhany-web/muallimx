            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="course-video-card bg-gradient-to-br from-[#2CA9BD] via-[#65DBE4] to-[#2CA9BD] h-[320px] sm:h-[380px] md:h-[450px] flex items-center justify-center relative group overflow-hidden">
                    <?php if($advancedCourse->image): ?>
                        <img src="<?php echo e(asset('storage/' . $advancedCourse->image)); ?>" alt="<?php echo e($advancedCourse->title); ?>" 
            ...
            <div class="lg:col-span-1">
                <div class="sticky-purchase-card bg-white rounded-3xl shadow-2xl border-2 border-gray-100 p-6 sm:p-8 hover:shadow-3xl transition-all duration-300">
                    ...
                    <div class="text-center mb-6 pb-6 border-b-2 border-gray-100" id="priceDisplay">
                        <?php if($advancedCourse->price && $advancedCourse->price > 0): ?>
                            <div class="original-price">
                                <div class="text-5xl sm:text-6xl font-black text-[#1C2C39] mb-2" id="coursePrice" data-price="<?php echo e($advancedCourse->price); ?>"><?php echo e(number_format($advancedCourse->price)); ?></div>
                            ...
                            <div class="discount-price hidden mt-4 pt-4 border-t-2 border-gray-200">
                                <div class="flex items-center justify-center gap-2 mb-3">
                                    <span class="text-sm text-gray-400 line-through font-medium" id="originalPriceDisplay"><?php echo e(number_format($advancedCourse->price)); ?> ج.م</span>
                                ...
                                <div class="text-5xl sm:text-6xl font-black text-emerald-600 mb-2" id="finalPriceDisplay"><?php echo e(number_format($advancedCourse->price)); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\student\courses\show.blade.php ENDPATH**/ ?>