                        ...
                        <?php if(!$advancedCourse->is_free && $advancedCourse->effectivePurchasePrice() > 0): ?>
                            <div class="original-price">
                                <?php if($advancedCourse->hasPromotionalPrice()): ?>
                                    ...
                                    <div class="text-2xl text-gray-400 line-through mb-3 tabular-nums"><?php echo e(number_format($advancedCourse->listPriceAmount())); ?> <span class="text-base">ج.م</span></div>
                            ...
                            <div class="discount-price hidden mt-4 pt-4 border-t-2 border-gray-200">
                                <div class="flex items-center justify-center gap-2 mb-3">
                                    <span class="text-sm text-gray-400 line-through font-medium" id="originalPriceDisplay"><?php echo e(number_format($advancedCourse->effectivePurchasePrice())); ?> ج.م</span>
