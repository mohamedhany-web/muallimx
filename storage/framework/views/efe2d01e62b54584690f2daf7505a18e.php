        ...
        <ul class="space-y-0.5">
            ...
            <li x-data="{ open: <?php echo e($studentControlOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.video-library')) && Route::has('admin.video-library.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.video-library.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.video-library.*') ? 'active' : ''); ?>">
            ...
            <?php if($isFull || $u->hasPermission('manage.coupons') || $u->hasPermission('manage.referrals') || $u->hasPermission('manage.loyalty') || $u->hasPermission('manage.popup-ads') || $u->hasPermission('manage.landing-pages') || $u->hasPermission('manage.personal-branding')): ?>
            ...
            <li x-data="{ open: <?php echo e($marketingOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.landing-pages')): ?>
                    <li><a href="<?php echo e(route('admin.landing-pages.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.landing-pages.*') ? 'active' : ''); ?>"><i class="fas fa-pager"></i><span>صفحات الهبوط</span></a></li>
                    <?php endif; ?>
            ...
            <?php if($isFull || $u->hasPermission('manage.subscriptions') || $u->hasPermission('manage.packages') || $u->hasPermission('manage.teacher-features') || $u->hasPermission('manage.curriculum-library') || $u->hasPermission('manage.video-library')): ?>
            ...
            <li x-data="{ open: <?php echo e($paidSubscriptionsOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.video-library')): ?>
                    <li><a href="<?php echo e(route('admin.video-library.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.video-library.*') ? 'active' : ''); ?>"><i class="fas fa-play-circle"></i><span>مكتبة الفيديو</span></a></li>
                    <?php endif; ?>
