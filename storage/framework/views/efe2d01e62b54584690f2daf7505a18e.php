        ...
        <ul class="space-y-0.5">
            ...
            <li x-data="{ open: <?php echo e($studentControlOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.teacher-features.index')): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.curriculum-library.index')): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.reports.users')): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.students-control.paid-features')): ?>
                    <li>
            ...
            <?php $salesSectionOpen = request()->routeIs('admin.orders.*') || request()->routeIs('admin.coupons.*') || request()->routeIs('admin.referrals.*') || request()->routeIs('admin.referral-programs.*'); ?>
            ...
            <li x-data="{ open: <?php echo e($liveOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    <?php if(Route::has('admin.live-sessions.index')): ?>
                        <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.live-recordings.index')): ?>
                        <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.live-servers.index')): ?>
                        <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.live-servers.control')): ?>
                        <li>
                    ...
                    <?php endif; ?>
                    <?php if(Route::has('admin.live-settings.index')): ?>
                        <li>
            ...
            <?php $employeesOpen = request()->routeIs('admin.employees.*') || request()->routeIs('admin.employee-jobs.*') || request()->routeIs('admin.employee-tasks.*') || request()->routeIs('admin.leaves.*') || request()->routeIs('admin.tasks.*') || request()->routeIs('admin.instructor-requests.*'); ?>
    ...
    <div class="px-3 py-3 flex-shrink-0 border-t border-slate-200 dark:border-slate-600">
        <div class="sidebar-user-wrap flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-slate-700/50 dark:hover:bg-slate-700 transition-colors">
            <?php if(auth()->user()->profile_image): ?>
                <img src="<?php echo e(asset('storage/' . auth()->user()->profile_image)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="w-8 h-8 rounded-lg object-cover ring-1 ring-slate-200 flex-shrink-0" onerror="this.style.display='none'; this.nextElementSibling?.classList.remove('hidden');">
