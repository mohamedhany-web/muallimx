...
<?php $__env->startSection('title', 'إضافة إنجاز جديد'); ?>
<?php $__env->startSection('header', 'إضافة إنجاز جديد'); ?>
...
<div class="space-y-6">
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <form action="<?php echo e(route('admin.achievements.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="<?php echo e(old('icon', 'fas fa-medal')); ?>" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                ...
                <div>
                    ...
                    <input type="number" name="points" min="0" value="<?php echo e(old('points', 0)); ?>" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\achievements\create.blade.php ENDPATH**/ ?>