<?php $__env->startSection('title', __('instructor.my_courses') . ' - Mindlytics'); ?>
...
<div class="space-y-6">
    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200 shadow-sm">
        <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 mb-1"><?php echo e(__('instructor.my_courses')); ?></h1>
        <p class="text-sm text-slate-500"><?php echo e(__('instructor.courses_assigned_to_you')); ?></p>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/instructor/courses/index.blade.php ENDPATH**/ ?>