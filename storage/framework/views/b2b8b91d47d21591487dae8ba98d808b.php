...
<?php $__env->startSection('title', 'الملف التعريفي - my portfolio'); ?>
<?php $__env->startSection('header', 'الملف التعريفي'); ?>
...
<div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800/95 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        <form action="<?php echo e(route('student.portfolio.profile.update')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-700 p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="url" name="linkedin" value="<?php echo e(old('linkedin', $social['linkedin'] ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="twitter" value="<?php echo e(old('twitter', $social['twitter'] ?? '')); ?>"
                               class="w-full rounded-xl border-2 border-slate-200 dark:border-slate-700 px-4 py-3 bg-white dark:bg-slate-900/30">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 dark:text-slate-200 mb-2"><i class="fab fa-youtube ml-2"></i>YouTube</label>
                        <input type="url" name="youtube" value="<?php echo e(old('youtube', $social['youtube'] ?? '')); ?>"
                               class="w-full rounded-xl border-2 border-slate-200 dark:border-slate-700 px-4 py-3 bg-white dark:bg-slate-900/30">
                    </div>
                    <div>
                        ...
                        <input type="url" name="facebook" value="<?php echo e(old('facebook', $social['facebook'] ?? '')); ?>"
                               class="w-full rounded-xl border-2 border-slate-200 dark:border-slate-700 px-4 py-3 bg-white dark:bg-slate-900/30">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input type="url" name="website" value="<?php echo e(old('website', $social['website'] ?? '')); ?>"
                               class="w-full rounded-xl border-2 border-slate-200 dark:border-slate-700 px-4 py-3 bg-white dark:bg-slate-900/30">
                    </div>
                </div>
            </div>
