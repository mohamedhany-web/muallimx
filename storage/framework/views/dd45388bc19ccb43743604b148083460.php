                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex flex-col items-center gap-1.5">
                                    ...
                                    <form method="POST"
                                          action="<?php echo e(route('admin.n8n.live-session-reports.regenerate', ['source' => $report->source, 'report' => $report->id])); ?>"
                                          onsubmit="return confirm('إعادة إرسال طلب التقرير إلى n8n؟ سيُعاد توليده لنفس المستخدم عند اكتمال المعالجة.');">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                                class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border border-amber-400 bg-amber-50 hover:bg-amber-100 text-amber-900 text-xs font-semibold dark:bg-amber-950/40 dark:border-amber-700 dark:text-amber-200 dark:hover:bg-amber-900/50">
