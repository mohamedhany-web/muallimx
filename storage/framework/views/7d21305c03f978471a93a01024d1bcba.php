        ...
        <div class="container-1200 relative z-10">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-10 reveal s2">
                ...
                <article class="rounded-2xl p-4 sm:p-5 border border-slate-200 bg-[#fffbea] text-center shadow-[0_10px_24px_-18px_rgba(31,42,122,.25)]">
                    <p class="text-3xl sm:text-4xl font-black text-mx-indigo" dir="ltr"><?php echo e($fmt((int) ($hs['learning_paths'] ?? 0))); ?></p>
    ...
    <section class="py-12 sm:py-14 bg-mx-soft">
        <div class="container-1200">
            <div class="max-w-3xl mb-7 reveal">
                <h2 class="font-heading text-3xl sm:text-4xl font-black text-mx-indigo mb-3"><?php echo e(__('public.categories_sidebar')); ?></h2>
                <p class="text-slate-600 text-sm sm:text-base leading-7"><?php echo e(__('public.home_categories_subtitle')); ?></p>
            </div>
            <div class="grid grid-cols-2 lg:grid-cols-6 gap-4">
                <?php $__currentLoopData = ($homeCategories ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($cat['url'] ?? route('public.courses')); ?>" class="reveal <?php echo e($i === 1 ? 'lg:translate-y-2' : ''); ?> <?php echo e($i === 4 ? 'lg:-translate-y-2' : ''); ?> card-base hover-lift text-center block no-underline text-inherit">
                        ...
                        <h3 class="font-semibold text-sm text-mx-indigo leading-snug px-1"><?php echo e($cat['name']); ?></h3>
                        <?php if(! empty($cat['courses_count'])): ?>
                            <p class="text-[11px] text-slate-500 mt-2 font-medium"><?php echo e(__('public.home_category_courses_line', ['count' => $cat['courses_count']])); ?></p>
                        <?php endif; ?>
                    </a>
