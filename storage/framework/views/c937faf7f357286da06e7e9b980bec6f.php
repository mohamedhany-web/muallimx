...
<div class="p-4 md:p-6 space-y-6" style="background: #f8fafc;">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-2xl shadow p-6 border-2 border-amber-200">
            ...
            <p class="text-2xl font-black text-amber-700"><?php echo e(number_format($globalStats['pending_total'], 2)); ?> ج.م</p>
        </div>
        <div class="bg-white rounded-2xl shadow p-6 border-2 border-emerald-200">
            ...
            <p class="text-2xl font-black text-emerald-700"><?php echo e(number_format($globalStats['paid_total'], 2)); ?> ج.م</p>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4">
                            <?php if(($stats['paid_total'] ?? 0) > 0): ?>
                                <span class="font-bold text-emerald-700"><?php echo e(number_format($stats['paid_total'], 2)); ?> ج.م</span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/admin/accounting/instructor-accounts/index.blade.php ENDPATH**/ ?>