    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 mb-8 border border-gray-200 dark:border-slate-700 hover:shadow-2xl transition-all duration-300 card-hover-effect">
        ...
        <form method="GET" action="<?php echo e(route('admin.referrals.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">إلى تاريخ</label>
                <input type="date" name="date_to" value="<?php echo e(request('date_to')); ?>" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all">
            </div>
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('admin.referrals.index')); ?>" class="bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-800 dark:text-slate-100 px-5 py-3 rounded-xl font-medium transition-colors">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/40">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="mr-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-slate-100"><?php echo e($referral->referrer->name ?? 'غير معروف'); ?></div>
                                    <div class="text-sm text-gray-500 dark:text-slate-400"><?php echo e($referral->referrer->phone ?? 'N/A'); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900 dark:text-slate-100"><?php echo e($referral->referralProgram->name ?? '-'); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-mono font-bold text-gray-900 dark:text-slate-100"><?php echo e($referral->referral_code ?? $referral->code ?? '-'); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
