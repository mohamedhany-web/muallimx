...
<div class="space-y-6">
    ...
    <p class="text-sm text-gray-700 mt-2">
        <a href="<?php echo e(route('admin.portfolio-marketing-profiles.index')); ?>" class="font-bold text-emerald-700 hover:underline"><i class="fas fa-id-card ml-1"></i>مراجعة الملف التعريفي التسويقي للطلاب (صورة ونبذة)</a>
