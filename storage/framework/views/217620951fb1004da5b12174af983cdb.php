...
<body class="bg-white text-navy-950 antialiased font-body" x-data="{ isSubmitting: false }">
    ...
    <main class="flex-1 pt-20">
        ...
        <section class="relative py-12 lg:py-16 overflow-hidden bg-navy-950">
            ...
            <div class="absolute top-0 <?php echo e($isRtl?'left-0':'right-0'); ?> w-96 h-96 rounded-full bg-brand-500/10 blur-[100px]"></div>
            <div class="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
                <nav class="text-sm text-slate-400 mb-6 flex items-center gap-2">
                    ...
                    <span>/</span>
                    <a href="<?php echo e(route('public.courses')); ?>" class="hover:text-white transition-colors">الكورسات</a>
                    <span>/</span>
                    <?php if(isset($course)): ?>
                        <a href="<?php echo e(route('public.course.show', $course->id)); ?>" class="hover:text-white transition-colors"><?php echo e(Str::limit($course->title ?? 'الكورس', 30)); ?></a>
                    <?php endif; ?>
                    <span>/</span>
                ...
                <div class="text-center max-w-2xl mx-auto">
                    ...
                    <p class="text-slate-300 text-lg reveal">خطوة أخيرة للحصول على <?php echo e(isset($course) ? 'الكورس' : 'المسار التعليمي'); ?></p>
                </div>
            </div>
