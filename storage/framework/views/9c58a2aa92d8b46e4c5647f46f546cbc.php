...
<div class="w-full max-w-md">
    <div class="bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 p-6 sm:p-8">
        ...
        <form method="POST" action="<?php echo e(route('community.login.post')); ?>" class="space-y-4">
            ...
            <div>
                <label for="email" class="block text-sm font-bold text-slate-700 mb-1"><?php echo e(__('auth.email')); ?></label>
                <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required autofocus
                       ...
                       placeholder="<?php echo e(__('auth.email')); ?>" dir="ltr">
            </div>
            <div>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="remember" class="text-sm text-slate-600 font-medium"><?php echo e(__('auth.remember')); ?></label>
            </div>
        ...
        <div class="mt-6 pt-6 border-t border-slate-200 space-y-2">
            ...
            <p class="text-center text-slate-500 text-xs">
                <a href="<?php echo e(route('login')); ?>" class="hover:text-slate-700 hover:underline">تسجيل الدخول من المنصة الرئيسية</a>
            </p>
        </div>
    </div>
</div>
