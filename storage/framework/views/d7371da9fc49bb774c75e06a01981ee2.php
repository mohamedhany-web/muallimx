...
<?php $__env->startSection('title', 'تعديل المسابقة'); ?>
<?php $__env->startSection('header', 'تعديل المسابقة'); ?>

<?php $__env->startSection('content'); ?>
<div class="w-full">
    <form action="<?php echo e(route('admin.community.competitions.update', $competition)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <p class="text-slate-600 text-sm">تعديل بيانات المسابقة. التغييرات تنعكس فوراً في واجهة المجتمع.</p>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="<?php echo e(old('title', $competition->title)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5" placeholder="وصف مختصر أو تفصيلي عن المسابقة وأهدافها..."
                                      class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-colors resize-y min-h-[120px]"><?php echo e(old('description', $competition->description)); ?></textarea>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <textarea name="rules" id="rules" rows="4" placeholder="قواعد المسابقة، معايير التقييم، أو أي شروط مشاركة..."
                                  class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-colors resize-y min-h-[100px]"><?php echo e(old('rules', $competition->rules)); ?></textarea>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <input type="datetime-local" name="start_at" id="start_at" value="<?php echo e(old('start_at', $competition->start_at?->format('Y-m-d\TH:i'))); ?>"
                                   class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-colors">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="end_at" id="end_at" value="<?php echo e(old('end_at', $competition->end_at?->format('Y-m-d\TH:i'))); ?>"
                                   class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-colors">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        <label class="flex items-center gap-3 p-4 rounded-xl border-2 border-slate-100 hover:border-cyan-100 cursor-pointer transition-colors has-[:checked]:border-cyan-200 has-[:checked]:bg-cyan-50/50">
                            ...
                            <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $competition->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\community\competitions\edit.blade.php ENDPATH**/ ?>