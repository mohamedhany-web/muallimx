        ...
        <div class="p-5 sm:p-8 space-y-6">
            <div class="flex flex-wrap gap-4 items-start">
                ...
                <div>
                    ...
                    <?php if(!empty($personal_branding->social_links['linkedin'])): ?>
                    <p class="text-slate-500 text-sm mt-1">LinkedIn: <a href="<?php echo e($personal_branding->social_links['linkedin']); ?>" target="_blank" rel="noopener" class="text-sky-600 hover:text-sky-700"><?php echo e($personal_branding->social_links['linkedin']); ?></a></p>
                    <?php endif; ?>
