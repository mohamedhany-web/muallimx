...
<div class="space-y-6"
     x-data="landingPageEditor(<?php echo \Illuminate\Support\Js::from($initialSections)->toHtml() ?>)"
     x-init="syncJson()">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" value="<?php echo e(old('title', $landingPage->title ?? '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <div class="flex items-center gap-2" dir="ltr">
                    ...
                    <input type="text" name="slug" value="<?php echo e(old('slug', $landingPage->slug ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center gap-3 pt-6">
                <label class="inline-flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" class="rounded border-slate-300 text-sky-600"
                           <?php if(old('is_active', $landingPage->is_active ?? true)): echo 'checked'; endif; ?>>
            ...
            <div>
                ...
                <input type="text" name="headline" value="<?php echo e(old('headline', $landingPage->headline ?? '')); ?>"
            ...
            <div>
                ...
                <input type="text" name="subheadline" value="<?php echo e(old('subheadline', $landingPage->subheadline ?? '')); ?>"
                       class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm">
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">بداية النشر</label>
                <input type="datetime-local" name="starts_at"
                       value="<?php echo e(old('starts_at', isset($landingPage) && $landingPage->starts_at ? $landingPage->starts_at->format('Y-m-d\TH:i') : '')); ?>"
                       class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm">
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">نهاية النشر</label>
                <input type="datetime-local" name="ends_at"
                       value="<?php echo e(old('ends_at', isset($landingPage) && $landingPage->ends_at ? $landingPage->ends_at->format('Y-m-d\TH:i') : '')); ?>"
                       class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm">
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="meta_title" value="<?php echo e(old('meta_title', $landingPage->meta_title ?? '')); ?>"
                       class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm">
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">UTM Source</label>
                <input type="text" name="utm_source" value="<?php echo e(old('utm_source', $landingPage->utm_source ?? '')); ?>"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="meta_description" rows="2" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm"><?php echo e(old('meta_description', $landingPage->meta_description ?? '')); ?></textarea>
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">UTM Campaign</label>
                <input type="text" name="utm_campaign" value="<?php echo e(old('utm_campaign', $landingPage->utm_campaign ?? '')); ?>"
            ...
            <div>
                ...
                <?php if(!empty($landingPage?->og_image_path)): ?>
                    <div class="mt-2 flex items-center gap-3">
                        <img src="<?php echo e($landingPage->ogImageUrl()); ?>" alt="" class="h-14 rounded-lg border border-slate-200">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 space-y-4">
        ...
        <?php $__errorArgs = ['sections_json'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="p-3 bg-rose-50 border border-rose-200 rounded-xl text-rose-700 text-sm"><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php if (! $__env->hasRenderedOnce('e6028dab-a2c4-4879-9cd8-40becb484294')): $__env->markAsRenderedOnce('e6028dab-a2c4-4879-9cd8-40becb484294'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\landing-pages\_form.blade.php ENDPATH**/ ?>