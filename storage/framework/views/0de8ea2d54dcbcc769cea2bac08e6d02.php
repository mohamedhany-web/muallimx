...
<?php $__env->startSection('title', 'آراء الموقع'); ?>
<?php $__env->startSection('header', 'آراء الموقع — الصفحة الرئيسية'); ?>
...
<div class="w-full space-y-6">
    <div class="rounded-3xl bg-white/95 backdrop-blur border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-5 py-6 sm:px-8 border-b border-slate-200 flex flex-wrap items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('admin.site-testimonials.create')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-violet-500 to-indigo-600 hover:from-violet-600 hover:to-indigo-700 text-white rounded-xl font-semibold shadow-lg transition-all">
        ...
        <div class="p-5 sm:p-8">
            ...
            <form method="GET" class="flex flex-wrap gap-3 mb-6">
                <input type="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="بحث في النص أو الاسم..."
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 max-w-xs">
                                <?php if($row->isImageType() && $row->publicImageUrl()): ?>
                                    <img src="<?php echo e($row->publicImageUrl()); ?>" alt="" class="h-12 w-20 object-cover rounded-lg border border-slate-200">
                                <?php else: ?>
                                    <span class="text-slate-600 line-clamp-2"><?php echo e(Str::limit(strip_tags($row->body ?? ''), 80)); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-3 text-slate-800"><?php echo e($row->author_name ?? '—'); ?></td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <a href="<?php echo e(route('admin.site-testimonials.edit', $row)); ?>" class="text-sky-600 hover:text-sky-700 font-medium ml-2">تعديل</a>
                        ...
                        <tr>
                            <td colspan="7" class="px-4 py-12 text-center text-slate-500">
                                ...
                                <p>لا توجد آراء بعد. <a href="<?php echo e(route('admin.site-testimonials.create')); ?>" class="text-sky-600 hover:underline">أضف أول رأي</a></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\site-testimonials\index.blade.php ENDPATH**/ ?>