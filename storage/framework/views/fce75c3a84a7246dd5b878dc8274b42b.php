...
<body class="min-h-screen flex flex-col text-gray-100">
    <header class="flex-shrink-0 py-4 px-4 sm:px-6">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            <a href="<?php echo e(route('public.community.index')); ?>" class="flex items-center gap-2 text-white font-bold text-lg hover:opacity-90">
            ...
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-slate-300 hover:text-white"><?php echo e(__('auth.home')); ?></a>
        </div>
    </header>
