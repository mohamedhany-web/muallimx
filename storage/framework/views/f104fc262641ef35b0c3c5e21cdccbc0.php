...
<?php $__env->startSection('title', 'المسارات التعليمية'); ?>
<?php $__env->startSection('header', 'المسارات التعليمية'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-slate-800/95 rounded-2xl shadow-lg border-2 border-gray-200 hover:border-green-300 transition-all duration-300 overflow-hidden group">
                <div class="h-48 bg-gradient-to-br from-green-500 via-blue-500 to-green-600 flex items-center justify-center relative overflow-hidden">
                    ...
                    <?php if($path->icon): ?>
                        <i class="<?php echo e($path->icon); ?> text-white text-6xl relative z-10 group-hover:scale-110 transition-transform"></i>
                    <?php else: ?>
                ...
                <div class="p-6">
                    ...
                    <?php if($path->description): ?>
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($path->description, 100)); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-4 text-sm text-gray-600">
                            <span class="flex items-center gap-1">
                                ...
                                <?php echo e($path->academic_subjects_count); ?> مادة
                            </span>
                            <span class="flex items-center gap-1">
                                <i class="fas fa-book text-green-600"></i>
                                <?php echo e($path->linked_courses_count); ?> كورس
                            </span>
                        </div>
                    </div>
                    
                    <a href="<?php echo e(route('instructor.learning-path.show', $path->slug)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\instructor\learning-path\index.blade.php ENDPATH**/ ?>