...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800/95 rounded-xl p-5 border border-gray-200 dark:border-slate-700 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-slate-100 mb-1"><?php echo e(__('student.my_courses_active_title')); ?></h1>
                <p class="text-sm text-gray-500 dark:text-slate-400"><?php echo e(__('student.my_courses_subtitle')); ?></p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views/student/my-courses/index.blade.php ENDPATH**/ ?>