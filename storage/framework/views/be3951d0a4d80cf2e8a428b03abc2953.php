...
<div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6" style="background: #f8fafc; min-height: 100vh;">
        ...
        <div class="px-4 py-6 sm:px-8 sm:py-8 relative overflow-hidden">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="space-y-4">
                    ...
                    <h1 class="text-3xl font-black text-gray-900 leading-tight">تعديل مهمة: <?php echo e($employeeTask->title); ?></h1>
                </div>
                <a href="<?php echo e(route('admin.employee-tasks.show', $employeeTask)); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gray-500 hover:bg-gray-600 text-white text-sm font-bold shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto">
    ...
    <div class="dashboard-card rounded-2xl card-hover-effect border-2 border-gray-200/50 hover:border-blue-300/70 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 250, 252, 0.95) 100%);">
        <form action="<?php echo e(route('admin.employee-tasks.update', $employeeTask)); ?>" method="POST" class="p-6 sm:p-8 space-y-8">
            <?php echo csrf_field(); ?>
                        ...
                        <select name="employee_id" id="employee_id" required class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($employee->id); ?>"
                                        ...
                                        <?php echo e(old('employee_id', $employeeTask->employee_id) == $employee->id ? 'selected' : ''); ?>>
                                    <?php echo e($employee->name); ?>

                                    <?php if($employee->employee_code): ?>(<?php echo e($employee->employee_code); ?>)<?php endif; ?>
                                    <?php if($employee->employeeJob): ?> - <?php echo e($employee->employeeJob->name); ?><?php endif; ?>
                                </option>
                        ...
                        <select name="task_type" id="task_type" required class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
                            <?php $__currentLoopData = $taskTypeDefinitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($code); ?>"
                                        ...
                                        <?php endif; ?>
                                        <?php echo e(old('task_type', $employeeTask->task_type ?? 'general') === $code ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title', $employeeTask->title)); ?>" required class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition"><?php echo e(old('description', $employeeTask->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="priority" id="priority" required class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
                            <option value="low" <?php echo e(old('priority', $employeeTask->priority) == 'low' ? 'selected' : ''); ?>>منخفضة</option>
                            <option value="medium" <?php echo e(old('priority', $employeeTask->priority) == 'medium' ? 'selected' : ''); ?>>متوسطة</option>
                            <option value="high" <?php echo e(old('priority', $employeeTask->priority) == 'high' ? 'selected' : ''); ?>>عالية</option>
                            <option value="urgent" <?php echo e(old('priority', $employeeTask->priority) == 'urgent' ? 'selected' : ''); ?>>عاجلة</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
                            <option value="pending" <?php echo e(old('status', $employeeTask->status) == 'pending' ? 'selected' : ''); ?>>معلقة</option>
                            <option value="in_progress" <?php echo e(old('status', $employeeTask->status) == 'in_progress' ? 'selected' : ''); ?>>قيد التنفيذ</option>
                            <option value="completed" <?php echo e(old('status', $employeeTask->status) == 'completed' ? 'selected' : ''); ?>>مكتملة</option>
                            <option value="cancelled" <?php echo e(old('status', $employeeTask->status) == 'cancelled' ? 'selected' : ''); ?>>ملغاة</option>
                            <option value="on_hold" <?php echo e(old('status', $employeeTask->status) == 'on_hold' ? 'selected' : ''); ?>>معلقة مؤقتاً</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="deadline" id="deadline" value="<?php echo e(old('deadline', $employeeTask->deadline?->format('Y-m-d'))); ?>" class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="progress" id="progress" value="<?php echo e(old('progress', $employeeTask->progress)); ?>" min="0" max="100" class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition"><?php echo e(old('notes', $employeeTask->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 pt-6 border-t border-gray-100">
                <a href="<?php echo e(route('admin.employee-tasks.show', $employeeTask)); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 text-sm font-bold shadow-lg hover:shadow-xl transition-all duration-300">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\employee-tasks\edit.blade.php ENDPATH**/ ?>