                                ...
                                <?php for($i = 0; $i < 5; $i++): ?>
                                    <div class="flex items-center gap-3">
                                        <input type="radio" name="correct_option" value="<?php echo e($i); ?>" id="correct_<?php echo e($i); ?>"
                                               <?php echo e((is_array($question->correct_answer) && in_array((string)$i, $question->correct_answer)) ? 'checked' : ''); ?>
                        ...
                        <?php if($question->image_url): ?>
                            <div class="mb-6">
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="relative">
                                        <img src="<?php echo e(asset('storage/' . $question->image_url)); ?>" 
                                             alt="صورة السؤال" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\admin\question-bank\edit.blade.php ENDPATH**/ ?>