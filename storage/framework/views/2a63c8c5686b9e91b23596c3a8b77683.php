<?php $__env->startSection('title', __('public.instructors_page_title')); ?>
<?php $__env->startSection('content'); ?>
<div class="max-w-6xl mx-auto px-4 sm:px-6 py-12">
    <div class="text-center mb-12">
        <h1 class="text-3xl md:text-4xl font-bold text-slate-900 mb-2"><?php echo e(__('public.instructors_heading')); ?></h1>
        <p class="text-slate-600"><?php echo e(__('public.instructors_subtitle')); ?></p>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('public.instructors.show', $p->user)); ?>" class="group rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-lg overflow-hidden block">
            ...
            <div class="p-5">
                ...
                <p class="text-sm text-slate-600 mt-1"><?php echo e($p->headline ?? __('public.instructor_fallback')); ?></p>
            </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="col-span-full text-center py-12 text-slate-500"><?php echo e(__('public.no_instructors')); ?></div>
        <?php endif; ?>
    </div>
</div>
