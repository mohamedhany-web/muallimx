    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white dark:bg-slate-800/95 border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5"><?php echo e($exam->title); ?></p>
            </div>
                            ...
                            <div class="rounded-xl p-4 bg-white dark:bg-slate-800/95 border border-slate-200 dark:border-slate-700 hover:border-sky-300 hover:shadow-sm transition-all flex items-start justify-between gap-4">
                                <div class="flex items-start gap-3 flex-1 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold text-slate-800 dark:text-slate-100 mb-1"><?php echo e($question->question); ?></p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <?php $__currentLoopData = $availableQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="rounded-xl p-4 border border-slate-200 dark:border-slate-700 hover:border-sky-300 bg-white dark:bg-slate-800/95 hover:shadow-sm transition-all">
                                <p class="font-semibold text-slate-800 dark:text-slate-100 mb-2 line-clamp-2"><?php echo e(Str::limit($question->question, 100)); ?></p>
                                ...
                                <form action="<?php echo e(route('instructor.exams.questions.add-from-bank', $exam)); ?>" method="POST" class="flex items-center gap-2">
                                    ...
                                    <input type="number" name="marks" value="<?php echo e($question->points ?? 1); ?>" min="0.5" step="0.5" required
    ...
    <div class="bg-white dark:bg-slate-800/95 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col"
        ...
        <?php if($questionBanks->isEmpty()): ?>
            <div class="p-6 text-center">
                ...
                <a href="<?php echo e(route('instructor.question-banks.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-sky-500 dark:bg-sky-600 hover:bg-sky-600 text-white rounded-xl font-semibold transition-colors">
    ...
    <div class="bg-white dark:bg-slate-800/95 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col" @click.stop>
        ...
        <div class="p-6 overflow-y-auto flex-1">
            ...
            <div class="space-y-3 max-h-80 overflow-y-auto">
                <?php $__currentLoopData = $availableQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form action="<?php echo e(route('instructor.exams.questions.add-from-bank', $exam)); ?>" method="POST" class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-sky-200 hover:bg-sky-50 dark:bg-sky-900/30/30 transition-colors">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="question_id" value="<?php echo e($question->id); ?>">
                        <div class="flex-1 min-w-0">
                            <p class="font-semibold text-slate-800 dark:text-slate-100 text-sm truncate"><?php echo e(Str::limit($question->question, 70)); ?></p>
                        ...
                        <input type="number" name="marks" value="<?php echo e($question->points ?? 1); ?>" min="0.5" step="0.5" required class="w-16 px-2 py-1.5 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Muallimx\resources\views/instructor/exams/manage-questions.blade.php ENDPATH**/ ?>