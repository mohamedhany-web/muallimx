...
<head>
    ...
    <title>429 - <?php echo e(__('errors.429_title')); ?> | <?php echo e(config('app.name')); ?></title>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 lg:py-20">
            <div class="text-center">
                ...
                <div class="inline-flex items-center gap-1 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-lg mb-6 fade-in-up">
                    ...
                    <span class="text-white font-bold text-sm"><?php echo e(__('errors.429_badge')); ?></span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center fade-in-up" style="animation-delay: 0.5s;">
                    ...
                    <a href="<?php echo e($errorHomeUrl); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-base border-2 border-purple-600 hover:bg-purple-50 transition-all duration-300">
...
<?php /**PATH C:\xampp\htdocs\Muallimx\resources\views\errors\429.blade.php ENDPATH**/ ?>