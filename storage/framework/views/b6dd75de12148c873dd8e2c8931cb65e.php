...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="url" name="twitter" value="<?php echo e(old('twitter', $profile->social_links['twitter'] ?? '')); ?>" placeholder="https://x.com/username" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="youtube" value="<?php echo e(old('youtube', $profile->social_links['youtube'] ?? '')); ?>" placeholder="https://www.youtube.com/@channel" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="facebook" value="<?php echo e(old('facebook', $profile->social_links['facebook'] ?? '')); ?>" placeholder="https://facebook.com/page" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="website" value="<?php echo e(old('website', $profile->social_links['website'] ?? '')); ?>" placeholder="https://example.com" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
        ...
        <div class="rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-5 bg-slate-50/60 dark:bg-slate-800/40">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="999999.99" name="consultation_price_egp" value="<?php echo e(old('consultation_price_egp', $profile->consultation_price_egp)); ?>" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" min="15" max="480" name="consultation_duration_minutes" value="<?php echo e(old('consultation_duration_minutes', $profile->consultation_duration_minutes)); ?>" class="w-full rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm" dir="ltr">
