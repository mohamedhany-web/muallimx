    ...
    public static function planDefaults(string $key): array
    {
        $plans = [
            ...
            'teacher_starter' => [
                ...
                'billing_cycle' => 'monthly',
                'subscription_type' => 'monthly',
                'features' => ['library_access', 'video_library_access', 'ai_tools', 'support', 'teacher_profile', 'visible_to_academies', 'can_apply_opportunities', 'full_ai_suite', 'teacher_evaluation', 'recommended_to_academies', 'priority_opportunities', 'direct_support'],
            ],
            'teacher_pro' => [
                ...
                'billing_cycle' => 'monthly',
                'subscription_type' => 'monthly',
                'features' => ['library_access', 'video_library_access', 'ai_tools', 'classroom_access', 'support', 'teacher_profile', 'visible_to_academies', 'can_apply_opportunities', 'full_ai_suite', 'teacher_evaluation', 'recommended_to_academies', 'priority_opportunities', 'direct_support'],
            ],
        ];
