...
class N8nClassroomMeetingReportController extends Controller
{
    ...
    /**
     * تحديث حالة وناتج تقرير اجتماع Classroom من n8n.
     */
    public function update(Request $request, ClassroomMeetingReport $report): JsonResponse
    {
